							...
							const &data)
{
    ...
    for (Uint8 i = 0; i < data.bearerContextsCount; i++)
    {
    	...
    	dynamic_cast<
    	BearerContextsInCreateBearerRequest&>(bearerContexts.getGroupedIe(msgType, 0));
    ...
    if (data.pgwsNodeLevelLoadControlInformationIePresent)
    {
        ...
        dynamic_cast<
        PgwsNodeLevelLoadControlInformationInCreateBearerRequest&>(pgwsNodeLevelLoadControlInformation.getGroupedIe(msgType, 0));
    ...
    if (data.pgwsApnLevelLoadControlInformationIePresent)
    {
        ...
        dynamic_cast<
        PgwsApnLevelLoadControlInformationInCreateBearerRequest&>(pgwsApnLevelLoadControlInformation.getGroupedIe(msgType, 1));
    ...
    if (data.sgwsNodeLevelLoadControlInformationIePresent)
    {
        ...
        dynamic_cast<
        SgwsNodeLevelLoadControlInformationInCreateBearerRequest&>(sgwsNodeLevelLoadControlInformation.getGroupedIe(msgType, 2));
    ...
    if (data.pgwsOverloadControlInformationIePresent)
    {
        ...
        dynamic_cast<
        PgwsOverloadControlInformationInCreateBearerRequest&>(pgwsOverloadControlInformation.getGroupedIe(msgType, 0));
    ...
    if (data.sgwsOverloadControlInformationIePresent)
    {
        ...
        dynamic_cast<
        SgwsOverloadControlInformationInCreateBearerRequest&>(sgwsOverloadControlInformation.getGroupedIe(msgType, 1));
