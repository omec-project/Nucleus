							...
							const &data)
{
    ...
    for (Uint8 i = 0; i < data.bearerContextsCount; i++)
    {
    	...
    	dynamic_cast<
    	BearerContextsInDeleteBearerResponse&>(bearerContexts.getGroupedIe(msgType, 0));
    ...
    if (data.mmeS4SgsnsOverloadControlInformationIePresent)
    {
        ...
        dynamic_cast<
        MmeS4SgsnsOverloadControlInformationInDeleteBearerResponse&>(mmeS4SgsnsOverloadControlInformation.getGroupedIe(msgType, 0));
    ...
    if (data.sgwsOverloadControlInformationIePresent)
    {
        ...
        dynamic_cast<
        SgwsOverloadControlInformationInDeleteBearerResponse&>(sgwsOverloadControlInformation.getGroupedIe(msgType, 1));
    ...
    if (data.twanEpdgsOverloadControlInformationIePresent)
    {
        ...
        dynamic_cast<
        TwanEpdgsOverloadControlInformationInDeleteBearerResponse&>(twanEpdgsOverloadControlInformation.getGroupedIe(msgType, 2));
