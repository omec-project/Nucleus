							...
							const &data)
{
    ...
    for (Uint8 i = 0; i < data.bearerContextsCount; i++)
    {
    	...
    	dynamic_cast<
    	BearerContextsInCreateBearerResponse&>(bearerContexts.getGroupedIe(msgType, 0));
    ...
    if (data.mmeS4SgsnsOverloadControlInformationIePresent)
    {
        ...
        dynamic_cast<
        MmeS4SgsnsOverloadControlInformationInCreateBearerResponse&>(mmeS4SgsnsOverloadControlInformation.getGroupedIe(msgType, 0));
    ...
    if (data.sgwsOverloadControlInformationIePresent)
    {
        ...
        dynamic_cast<
        SgwsOverloadControlInformationInCreateBearerResponse&>(sgwsOverloadControlInformation.getGroupedIe(msgType, 1));
    ...
    if (data.twanEpdgsOverloadControlInformationIePresent)
    {
        ...
        dynamic_cast<
        TwanEpdgsOverloadControlInformationInCreateBearerResponse&>(twanEpdgsOverloadControlInformation.getGroupedIe(msgType, 2));
