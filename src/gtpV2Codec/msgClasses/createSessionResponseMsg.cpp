							...
							const &data)
{
    ...
    for (Uint8 i = 0; i < data.bearerContextsCreatedCount; i++)
    {
        ...
        GtpV2Ie::encodeGtpV2IeHeader(buffer, header);
        startIndex = buffer.getCurrentIndex(); 
        BearerContextIe bearerContextsCreated=
        dynamic_cast<
    	...
    	dynamic_cast<
    	BearerContextsCreatedInCreateSessionResponse&>(bearerContextsCreated.getGroupedIe(msgType, 0));
    ...
    for (Uint8 i = 0; i < data.bearerContextsMarkedForRemovalCount; i++)
    {
        ...
        GtpV2Ie::encodeGtpV2IeHeader(buffer, header);
        startIndex = buffer.getCurrentIndex(); 
        BearerContextIe bearerContextsMarkedForRemoval=
        dynamic_cast<
        BearerContextIe&>(GtpV2IeFactory::getInstance().
        getIeObject(BearerContextIeType));
        BearerContextsMarkedForRemovalInCreateSessionResponse groupedIeInstance = 
    	dynamic_cast<
    	BearerContextsMarkedForRemovalInCreateSessionResponse&>(bearerContextsMarkedForRemoval.getGroupedIe(msgType, 1));
    ...
    if (data.chargingGatewayNameIePresent)
    {
        ...
        GtpV2Ie::encodeGtpV2IeHeader(buffer, header);
        startIndex = buffer.getCurrentIndex(); 
        FqdnIe chargingGatewayName=
        dynamic_cast<
        FqdnIe&>(GtpV2IeFactory::getInstance().getIeObject(FqdnIeType));
        rc = chargingGatewayName.encodeFqdnIe(buffer, data.chargingGatewayName);
        endIndex = buffer.getCurrentIndex();
        length = endIndex - startIndex;
    ...
    if (data.chargingGatewayAddressIePresent)
    {
        ...
        GtpV2Ie::encodeGtpV2IeHeader(buffer, header);
        startIndex = buffer.getCurrentIndex(); 
        IpAddressIe chargingGatewayAddress=
        dynamic_cast<
        IpAddressIe&>(GtpV2IeFactory::getInstance().getIeObject(IpAddressIeType));
        rc = chargingGatewayAddress.encodeIpAddressIe(buffer, data.chargingGatewayAddress);
        endIndex = buffer.getCurrentIndex();
        length = endIndex - startIndex;
    ...
    if (data.pgwFqCsidIePresent)
    {
        ...
        rc = pgwFqCsid.encodeFqCsidIe(buffer, data.pgwFqCsid);
        endIndex = buffer.getCurrentIndex();
        length = endIndex - startIndex;
    ...
    if (data.pgwLdnIePresent)
    {
        ...
        GtpV2Ie::encodeGtpV2IeHeader(buffer, header);
        startIndex = buffer.getCurrentIndex(); 
        LocalDistinguishedNameIe pgwLdn=
        dynamic_cast<
        LocalDistinguishedNameIe&>(GtpV2IeFactory::getInstance().getIeObject(LocalDistinguishedNameIeType));
        rc = pgwLdn.encodeLocalDistinguishedNameIe(buffer, data.pgwLdn);
        endIndex = buffer.getCurrentIndex();
        length = endIndex - startIndex;
    ...
    if (data.pgwBackOffTimeIePresent)
    {
        ...
        GtpV2Ie::encodeGtpV2IeHeader(buffer, header);
        startIndex = buffer.getCurrentIndex(); 
        EpcTimerIe pgwBackOffTime=
        dynamic_cast<
        EpcTimerIe&>(GtpV2IeFactory::getInstance().getIeObject(EpcTimerIeType));
        rc = pgwBackOffTime.encodeEpcTimerIe(buffer, data.pgwBackOffTime);
        endIndex = buffer.getCurrentIndex();
        length = endIndex - startIndex;
    ...
    if (data.pgwS5S8S2bFTeidIePresent)
    {
        ...
        GtpV2Ie::encodeGtpV2IeHeader(buffer, header);
        startIndex = buffer.getCurrentIndex(); 
        FTeidIe pgwS5S8S2bFTeid=
        dynamic_cast<
        FTeidIe&>(GtpV2IeFactory::getInstance().getIeObject(FTeidIeType));
        rc = pgwS5S8S2bFTeid.encodeFTeidIe(buffer, data.pgwS5S8S2bFTeid);
        endIndex = buffer.getCurrentIndex();
        length = endIndex - startIndex;
    ...
    if (data.trustedWlanIpv4ParametersIePresent)
    {
        ...
        GtpV2Ie::encodeGtpV2IeHeader(buffer, header);
        startIndex = buffer.getCurrentIndex(); 
        Ip4cpIe trustedWlanIpv4Parameters=
        dynamic_cast<
        Ip4cpIe&>(GtpV2IeFactory::getInstance().getIeObject(Ip4cpIeType));
        rc = trustedWlanIpv4Parameters.encodeIp4cpIe(buffer, data.trustedWlanIpv4Parameters);
        endIndex = buffer.getCurrentIndex();
        length = endIndex - startIndex;
    ...
    if (data.pgwsNodeLevelLoadControlInformationIePresent)
    {
        ...
        GtpV2Ie::encodeGtpV2IeHeader(buffer, header);
        startIndex = buffer.getCurrentIndex(); 
        LoadControlInformationIe pgwsNodeLevelLoadControlInformation=
        dynamic_cast<
        ...
        dynamic_cast<
        PgwsNodeLevelLoadControlInformationInCreateSessionResponse&>(pgwsNodeLevelLoadControlInformation.getGroupedIe(msgType, 0));
    ...
    if (data.pgwsApnLevelLoadControlInformationIePresent)
    {
        ...
        GtpV2Ie::encodeGtpV2IeHeader(buffer, header);
        startIndex = buffer.getCurrentIndex(); 
        LoadControlInformationIe pgwsApnLevelLoadControlInformation=
        dynamic_cast<
        LoadControlInformationIe&>(GtpV2IeFactory::getInstance().getIeObject(LoadControlInformationIeType));
        PgwsApnLevelLoadControlInformationInCreateSessionResponse groupedIeInstance =
        dynamic_cast<
        PgwsApnLevelLoadControlInformationInCreateSessionResponse&>(pgwsApnLevelLoadControlInformation.getGroupedIe(msgType, 1));
    ...
    if (data.sgwsNodeLevelLoadControlInformationIePresent)
    {
        ...
        GtpV2Ie::encodeGtpV2IeHeader(buffer, header);
        startIndex = buffer.getCurrentIndex(); 
        LoadControlInformationIe sgwsNodeLevelLoadControlInformation=
        dynamic_cast<
        LoadControlInformationIe&>(GtpV2IeFactory::getInstance().getIeObject(LoadControlInformationIeType));
        SgwsNodeLevelLoadControlInformationInCreateSessionResponse groupedIeInstance =
        dynamic_cast<
        SgwsNodeLevelLoadControlInformationInCreateSessionResponse&>(sgwsNodeLevelLoadControlInformation.getGroupedIe(msgType, 2));
    ...
    if (data.pgwsOverloadControlInformationIePresent)
    {
        ...
        GtpV2Ie::encodeGtpV2IeHeader(buffer, header);
        startIndex = buffer.getCurrentIndex(); 
        OverloadControlInformationIe pgwsOverloadControlInformation=
        dynamic_cast<
        ...
        dynamic_cast<
        PgwsOverloadControlInformationInCreateSessionResponse&>(pgwsOverloadControlInformation.getGroupedIe(msgType, 0));
    ...
    if (data.sgwsOverloadControlInformationIePresent)
    {
        ...
        dynamic_cast<
        SgwsOverloadControlInformationInCreateSessionResponse&>(sgwsOverloadControlInformation.getGroupedIe(msgType, 1));
    ...
    if (data.pdnConnectionChargingIdIePresent)
    {
        ...
        GtpV2Ie::encodeGtpV2IeHeader(buffer, header);
        startIndex = buffer.getCurrentIndex(); 
        ChargingIdIe pdnConnectionChargingId=
        dynamic_cast<
        ChargingIdIe&>(GtpV2IeFactory::getInstance().getIeObject(ChargingIdIeType));
        rc = pdnConnectionChargingId.encodeChargingIdIe(buffer, data.pdnConnectionChargingId);
        endIndex = buffer.getCurrentIndex();
        length = endIndex - startIndex;
...
displayCreateSessionResponseMsgData_v(CreateSessionResponseMsgData const &data, Debug &stream)
{
    ...
    if (data.chargingGatewayNameIePresent)
    {
        ...
        dynamic_cast<
        FqdnIe&>(GtpV2IeFactory::getInstance().getIeObject(FqdnIeType));
        chargingGatewayName.displayFqdnIe_v(data.chargingGatewayName, stream);
    ...
    if (data.chargingGatewayAddressIePresent)
    {
        ...
        dynamic_cast<
        IpAddressIe&>(GtpV2IeFactory::getInstance().getIeObject(IpAddressIeType));
        chargingGatewayAddress.displayIpAddressIe_v(data.chargingGatewayAddress, stream);
    ...
    if (data.pgwFqCsidIePresent)
    {
        ...
        dynamic_cast<
        FqCsidIe&>(GtpV2IeFactory::getInstance().getIeObject(FqCsidIeType));
        pgwFqCsid.displayFqCsidIe_v(data.pgwFqCsid, stream);
    ...
    if (data.pgwLdnIePresent)
    {
        ...
        dynamic_cast<
        LocalDistinguishedNameIe&>(GtpV2IeFactory::getInstance().getIeObject(LocalDistinguishedNameIeType));
        pgwLdn.displayLocalDistinguishedNameIe_v(data.pgwLdn, stream);
    ...
    if (data.pgwBackOffTimeIePresent)
    {
        ...
        dynamic_cast<
        EpcTimerIe&>(GtpV2IeFactory::getInstance().getIeObject(EpcTimerIeType));
        pgwBackOffTime.displayEpcTimerIe_v(data.pgwBackOffTime, stream);
    ...
    if (data.pgwS5S8S2bFTeidIePresent)
    {
        ...
        dynamic_cast<
        FTeidIe&>(GtpV2IeFactory::getInstance().getIeObject(FTeidIeType));
        pgwS5S8S2bFTeid.displayFTeidIe_v(data.pgwS5S8S2bFTeid, stream);
    ...
    if (data.trustedWlanIpv4ParametersIePresent)
    {
        ...
        dynamic_cast<
        Ip4cpIe&>(GtpV2IeFactory::getInstance().getIeObject(Ip4cpIeType));
        trustedWlanIpv4Parameters.displayIp4cpIe_v(data.trustedWlanIpv4Parameters, stream);
    ...
    if (data.pdnConnectionChargingIdIePresent)
    {
        ...
        dynamic_cast<
        ChargingIdIe&>(GtpV2IeFactory::getInstance().getIeObject(ChargingIdIeType));
        pdnConnectionChargingId.displayChargingIdIe_v(data.pdnConnectionChargingId, stream);
