							...
							const &data)
{
    ...
    for (Uint8 i = 0; i < data.bearerContextsModifiedCount; i++)
    {
        ...
        GtpV2Ie::encodeGtpV2IeHeader(buffer, header);
        startIndex = buffer.getCurrentIndex(); 
        BearerContextIe bearerContextsModified=
        dynamic_cast<
    	...
    	dynamic_cast<
    	BearerContextsModifiedInModifyBearerResponse&>(bearerContextsModified.getGroupedIe(msgType, 0));
    ...
    for (Uint8 i = 0; i < data.bearerContextsMarkedForRemovalCount; i++)
    {
    	...
    	dynamic_cast<
    	BearerContextsMarkedForRemovalInModifyBearerResponse&>(bearerContextsMarkedForRemoval.getGroupedIe(msgType, 1));
    ...
    if (data.pgwsNodeLevelLoadControlInformationIePresent)
    {
        ...
        dynamic_cast<
        PgwsNodeLevelLoadControlInformationInModifyBearerResponse&>(pgwsNodeLevelLoadControlInformation.getGroupedIe(msgType, 0));
    ...
    if (data.pgwsApnLevelLoadControlInformationIePresent)
    {
        ...
        dynamic_cast<
        PgwsApnLevelLoadControlInformationInModifyBearerResponse&>(pgwsApnLevelLoadControlInformation.getGroupedIe(msgType, 1));
    ...
    if (data.sgwsNodeLevelLoadControlInformationIePresent)
    {
        ...
        dynamic_cast<
        SgwsNodeLevelLoadControlInformationInModifyBearerResponse&>(sgwsNodeLevelLoadControlInformation.getGroupedIe(msgType, 2));
    ...
    if (data.pgwsOverloadControlInformationIePresent)
    {
        ...
        dynamic_cast<
        PgwsOverloadControlInformationInModifyBearerResponse&>(pgwsOverloadControlInformation.getGroupedIe(msgType, 0));
    ...
    if (data.sgwsOverloadControlInformationIePresent)
    {
        ...
        dynamic_cast<
        SgwsOverloadControlInformationInModifyBearerResponse&>(sgwsOverloadControlInformation.getGroupedIe(msgType, 1));
