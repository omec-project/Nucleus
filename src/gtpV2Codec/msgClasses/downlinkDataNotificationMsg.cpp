							...
							const &data)
{
    ...
    if (data.allocationRetentionPriorityIePresent)
    {
        ...
        GtpV2Ie::encodeGtpV2IeHeader(buffer, header);
        startIndex = buffer.getCurrentIndex(); 
        ArpIe allocationRetentionPriority=
        dynamic_cast<
        ArpIe&>(GtpV2IeFactory::getInstance().getIeObject(ArpIeType));
        rc = allocationRetentionPriority.encodeArpIe(buffer, data.allocationRetentionPriority);
        endIndex = buffer.getCurrentIndex();
        length = endIndex - startIndex;
    ...
    if (data.sgwsNodeLevelLoadControlInformationIePresent)
    {
        ...
        dynamic_cast<
        SgwsNodeLevelLoadControlInformationInDownlinkDataNotification&>(sgwsNodeLevelLoadControlInformation.getGroupedIe(msgType, 0));
    ...
    if (data.sgwsOverloadControlInformationIePresent)
    {
        ...
        dynamic_cast<
        SgwsOverloadControlInformationInDownlinkDataNotification&>(sgwsOverloadControlInformation.getGroupedIe(msgType, 0));
...
displayDownlinkDataNotificationMsgData_v(DownlinkDataNotificationMsgData const &data, Debug &stream)
{
    ...
    if (data.allocationRetentionPriorityIePresent)
    {
        ...
        dynamic_cast<
        ArpIe&>(GtpV2IeFactory::getInstance().getIeObject(ArpIeType));
        allocationRetentionPriority.displayArpIe_v(data.allocationRetentionPriority, stream);
