							...
							const &data)
{
    ...
    if (data.dataNotificationDelayIePresent)
    {
        ...
        GtpV2Ie::encodeGtpV2IeHeader(buffer, header);
        startIndex = buffer.getCurrentIndex(); 
        DelayValueIe dataNotificationDelay=
        dynamic_cast<
        DelayValueIe&>(GtpV2IeFactory::getInstance().getIeObject(DelayValueIeType));
        rc = dataNotificationDelay.encodeDelayValueIe(buffer, data.dataNotificationDelay);
        endIndex = buffer.getCurrentIndex();
        length = endIndex - startIndex;
    ...
    if (data.dlLowPriorityTrafficThrottlingIePresent)
    {
        ...
        GtpV2Ie::encodeGtpV2IeHeader(buffer, header);
        startIndex = buffer.getCurrentIndex(); 
        ThrottlingIe dlLowPriorityTrafficThrottling=
        dynamic_cast<
        ThrottlingIe&>(GtpV2IeFactory::getInstance().getIeObject(ThrottlingIeType));
        rc = dlLowPriorityTrafficThrottling.encodeThrottlingIe(buffer, data.dlLowPriorityTrafficThrottling);
        endIndex = buffer.getCurrentIndex();
        length = endIndex - startIndex;
    ...
    if (data.dlBufferingDurationIePresent)
    {
        ...
        GtpV2Ie::encodeGtpV2IeHeader(buffer, header);
        startIndex = buffer.getCurrentIndex(); 
        EpcTimerIe dlBufferingDuration=
        dynamic_cast<
        EpcTimerIe&>(GtpV2IeFactory::getInstance().getIeObject(EpcTimerIeType));
        rc = dlBufferingDuration.encodeEpcTimerIe(buffer, data.dlBufferingDuration);
        endIndex = buffer.getCurrentIndex();
        length = endIndex - startIndex;
    ...
    if (data.dlBufferingSuggestedPacketCountIePresent)
    {
        ...
        GtpV2Ie::encodeGtpV2IeHeader(buffer, header);
        startIndex = buffer.getCurrentIndex(); 
        IntegerNumberIe dlBufferingSuggestedPacketCount=
        dynamic_cast<
        IntegerNumberIe&>(GtpV2IeFactory::getInstance().getIeObject(IntegerNumberIeType));
        rc = dlBufferingSuggestedPacketCount.encodeIntegerNumberIe(buffer, data.dlBufferingSuggestedPacketCount);
        endIndex = buffer.getCurrentIndex();
        length = endIndex - startIndex;
...
displayDownlinkDataNotificationAcknowledgeMsgData_v(DownlinkDataNotificationAcknowledgeMsgData const &data, Debug &stream)
{
    ...
    if (data.dataNotificationDelayIePresent)
    {
        ...
        dynamic_cast<
        DelayValueIe&>(GtpV2IeFactory::getInstance().getIeObject(DelayValueIeType));
        dataNotificationDelay.displayDelayValueIe_v(data.dataNotificationDelay, stream);
    ...
    if (data.dlLowPriorityTrafficThrottlingIePresent)
    {
        ...
        dynamic_cast<
        ThrottlingIe&>(GtpV2IeFactory::getInstance().getIeObject(ThrottlingIeType));
        dlLowPriorityTrafficThrottling.displayThrottlingIe_v(data.dlLowPriorityTrafficThrottling, stream);
    ...
    if (data.dlBufferingDurationIePresent)
    {
        ...
        dynamic_cast<
        EpcTimerIe&>(GtpV2IeFactory::getInstance().getIeObject(EpcTimerIeType));
        dlBufferingDuration.displayEpcTimerIe_v(data.dlBufferingDuration, stream);
    ...
    if (data.dlBufferingSuggestedPacketCountIePresent)
    {
        ...
        dynamic_cast<
        IntegerNumberIe&>(GtpV2IeFactory::getInstance().getIeObject(IntegerNumberIeType));
        dlBufferingSuggestedPacketCount.displayIntegerNumberIe_v(data.dlBufferingSuggestedPacketCount, stream);
