							...
							const &data)
{
    ...
    for (Uint8 i = 0; i < data.failedBearerContextsCount; i++)
    {
        ...
        GtpV2Ie::encodeGtpV2IeHeader(buffer, header);
        startIndex = buffer.getCurrentIndex(); 
        BearerContextIe failedBearerContexts=
        dynamic_cast<
    	...
    	dynamic_cast<
    	FailedBearerContextsInDeleteBearerRequest&>(failedBearerContexts.getGroupedIe(msgType, 0));
    ...
    if (data.procedureTransactionIdIePresent)
    {
        ...
        GtpV2Ie::encodeGtpV2IeHeader(buffer, header);
        startIndex = buffer.getCurrentIndex(); 
        PtiIe procedureTransactionId=
        dynamic_cast<
        PtiIe&>(GtpV2IeFactory::getInstance().getIeObject(PtiIeType));
        rc = procedureTransactionId.encodePtiIe(buffer, data.procedureTransactionId);
        endIndex = buffer.getCurrentIndex();
        length = endIndex - startIndex;
    ...
    if (data.pgwsNodeLevelLoadControlInformationIePresent)
    {
        ...
        dynamic_cast<
        PgwsNodeLevelLoadControlInformationInDeleteBearerRequest&>(pgwsNodeLevelLoadControlInformation.getGroupedIe(msgType, 0));
    ...
    if (data.pgwsApnLevelLoadControlInformationIePresent)
    {
        ...
        dynamic_cast<
        PgwsApnLevelLoadControlInformationInDeleteBearerRequest&>(pgwsApnLevelLoadControlInformation.getGroupedIe(msgType, 1));
    ...
    if (data.sgwsNodeLevelLoadControlInformationIePresent)
    {
        ...
        dynamic_cast<
        SgwsNodeLevelLoadControlInformationInDeleteBearerRequest&>(sgwsNodeLevelLoadControlInformation.getGroupedIe(msgType, 2));
    ...
    if (data.pgwsOverloadControlInformationIePresent)
    {
        ...
        dynamic_cast<
        PgwsOverloadControlInformationInDeleteBearerRequest&>(pgwsOverloadControlInformation.getGroupedIe(msgType, 0));
    ...
    if (data.sgwsOverloadControlInformationIePresent)
    {
        ...
        dynamic_cast<
        SgwsOverloadControlInformationInDeleteBearerRequest&>(sgwsOverloadControlInformation.getGroupedIe(msgType, 1));
...
displayDeleteBearerRequestMsgData_v(DeleteBearerRequestMsgData const &data, Debug &stream)
{
    ...
    if (data.procedureTransactionIdIePresent)
    {
        ...
        dynamic_cast<
        PtiIe&>(GtpV2IeFactory::getInstance().getIeObject(PtiIeType));
        procedureTransactionId.displayPtiIe_v(data.procedureTransactionId, stream);
