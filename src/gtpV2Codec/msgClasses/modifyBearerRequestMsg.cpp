							...
							const &data)
{
    ...
    if (data.delayDownlinkPacketNotificationRequestIePresent)
    {
        ...
        GtpV2Ie::encodeGtpV2IeHeader(buffer, header);
        startIndex = buffer.getCurrentIndex(); 
        DelayValueIe delayDownlinkPacketNotificationRequest=
        dynamic_cast<
        DelayValueIe&>(GtpV2IeFactory::getInstance().getIeObject(DelayValueIeType));
        rc = delayDownlinkPacketNotificationRequest.encodeDelayValueIe(buffer, data.delayDownlinkPacketNotificationRequest);
        endIndex = buffer.getCurrentIndex();
        length = endIndex - startIndex;
    ...
    for (Uint8 i = 0; i < data.bearerContextsToBeModifiedCount; i++)
    {
        ...
        GtpV2Ie::encodeGtpV2IeHeader(buffer, header);
        startIndex = buffer.getCurrentIndex(); 
        BearerContextIe bearerContextsToBeModified=
        dynamic_cast<
    	...
    	dynamic_cast<
    	BearerContextsToBeModifiedInModifyBearerRequest&>(bearerContextsToBeModified.getGroupedIe(msgType, 0));
    ...
    for (Uint8 i = 0; i < data.bearerContextsToBeRemovedCount; i++)
    {
    	...
    	dynamic_cast<
    	BearerContextsToBeRemovedInModifyBearerRequest&>(bearerContextsToBeRemoved.getGroupedIe(msgType, 1));
    ...
    if (data.mmeS4SgsnsOverloadControlInformationIePresent)
    {
        ...
        dynamic_cast<
        MmeS4SgsnsOverloadControlInformationInModifyBearerRequest&>(mmeS4SgsnsOverloadControlInformation.getGroupedIe(msgType, 0));
    ...
    if (data.sgwsOverloadControlInformationIePresent)
    {
        ...
        dynamic_cast<
        SgwsOverloadControlInformationInModifyBearerRequest&>(sgwsOverloadControlInformation.getGroupedIe(msgType, 1));
    ...
    if (data.epdgsOverloadControlInformationIePresent)
    {
        ...
        GtpV2Ie::encodeGtpV2IeHeader(buffer, header);
        startIndex = buffer.getCurrentIndex(); 
        OverloadControlInformationIe epdgsOverloadControlInformation=
        dynamic_cast<
        OverloadControlInformationIe&>(GtpV2IeFactory::getInstance().getIeObject(OverloadControlInformationIeType));
        EpdgsOverloadControlInformationInModifyBearerRequest groupedIeInstance =
        dynamic_cast<
        EpdgsOverloadControlInformationInModifyBearerRequest&>(epdgsOverloadControlInformation.getGroupedIe(msgType, 2));
...
displayModifyBearerRequestMsgData_v(ModifyBearerRequestMsgData const &data, Debug &stream)
{
    ...
    if (data.delayDownlinkPacketNotificationRequestIePresent)
    {
        ...
        dynamic_cast<
        DelayValueIe&>(GtpV2IeFactory::getInstance().getIeObject(DelayValueIeType));
        delayDownlinkPacketNotificationRequest.displayDelayValueIe_v(data.delayDownlinkPacketNotificationRequest, stream);
