							...
							const &data)
{
    ...
    if (data.mmeS4SgsnsOverloadControlInformationIePresent)
    {
        ...
        dynamic_cast<
        MmeS4SgsnsOverloadControlInformationInDeleteSessionRequest&>(mmeS4SgsnsOverloadControlInformation.getGroupedIe(msgType, 0));
    ...
    if (data.sgwsOverloadControlInformationIePresent)
    {
        ...
        dynamic_cast<
        SgwsOverloadControlInformationInDeleteSessionRequest&>(sgwsOverloadControlInformation.getGroupedIe(msgType, 1));
    ...
    if (data.twanEpdgsOverloadControlInformationIePresent)
    {
        ...
        dynamic_cast<
        TwanEpdgsOverloadControlInformationInDeleteSessionRequest&>(twanEpdgsOverloadControlInformation.getGroupedIe(msgType, 2));
