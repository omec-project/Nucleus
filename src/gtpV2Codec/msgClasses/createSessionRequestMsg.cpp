							...
							const &data)
{
    ...
    if (data.pgwS5S8AddressForControlPlaneOrPmipIePresent)
    {
        ...
        GtpV2Ie::encodeGtpV2IeHeader(buffer, header);
        startIndex = buffer.getCurrentIndex(); 
        FTeidIe pgwS5S8AddressForControlPlaneOrPmip=
        dynamic_cast<
        FTeidIe&>(GtpV2IeFactory::getInstance().getIeObject(FTeidIeType));
        rc = pgwS5S8AddressForControlPlaneOrPmip.encodeFTeidIe(buffer, data.pgwS5S8AddressForControlPlaneOrPmip);
        endIndex = buffer.getCurrentIndex();
        length = endIndex - startIndex;
    ...
    GtpV2Ie::encodeGtpV2IeHeader(buffer, header);
    startIndex = buffer.getCurrentIndex(); 
    ApnIe accessPointName=
    dynamic_cast<
    ApnIe&>(GtpV2IeFactory::getInstance().getIeObject(ApnIeType));
    rc = accessPointName.encodeApnIe(buffer, data.accessPointName);
    endIndex = buffer.getCurrentIndex();
    length = endIndex - startIndex;
    ...
    if (data.pdnAddressAllocationIePresent)
    {
        ...
        GtpV2Ie::encodeGtpV2IeHeader(buffer, header);
        startIndex = buffer.getCurrentIndex(); 
        PaaIe pdnAddressAllocation=
        dynamic_cast<
        PaaIe&>(GtpV2IeFactory::getInstance().getIeObject(PaaIeType));
        rc = pdnAddressAllocation.encodePaaIe(buffer, data.pdnAddressAllocation);
        endIndex = buffer.getCurrentIndex();
        length = endIndex - startIndex;
    ...
    if (data.maximumApnRestrictionIePresent)
    {
        ...
        GtpV2Ie::encodeGtpV2IeHeader(buffer, header);
        startIndex = buffer.getCurrentIndex(); 
        ApnRestrictionIe maximumApnRestriction=
        dynamic_cast<
        ApnRestrictionIe&>(GtpV2IeFactory::getInstance().getIeObject(ApnRestrictionIeType));
        rc = maximumApnRestriction.encodeApnRestrictionIe(buffer, data.maximumApnRestriction);
        endIndex = buffer.getCurrentIndex();
        length = endIndex - startIndex;
    ...
    if (data.trustedWlanModeIndicationIePresent)
    {
        ...
        GtpV2Ie::encodeGtpV2IeHeader(buffer, header);
        startIndex = buffer.getCurrentIndex(); 
        TwmiIe trustedWlanModeIndication=
        dynamic_cast<
        TwmiIe&>(GtpV2IeFactory::getInstance().getIeObject(TwmiIeType));
        rc = trustedWlanModeIndication.encodeTwmiIe(buffer, data.trustedWlanModeIndication);
        endIndex = buffer.getCurrentIndex();
        length = endIndex - startIndex;
    ...
    if (data.protocolConfigurationOptionsIePresent)
    {
        ...
        GtpV2Ie::encodeGtpV2IeHeader(buffer, header);
        startIndex = buffer.getCurrentIndex(); 
        PcoIe protocolConfigurationOptions=
        dynamic_cast<
        PcoIe&>(GtpV2IeFactory::getInstance().getIeObject(PcoIeType));
        rc = protocolConfigurationOptions.encodePcoIe(buffer, data.protocolConfigurationOptions);
        endIndex = buffer.getCurrentIndex();
        length = endIndex - startIndex;
    ...
    for (Uint8 i = 0; i < data.bearerContextsToBeCreatedCount; i++)
    {
        ...
        GtpV2Ie::encodeGtpV2IeHeader(buffer, header);
        startIndex = buffer.getCurrentIndex(); 
        BearerContextIe bearerContextsToBeCreated=
        dynamic_cast<
    	...
    	dynamic_cast<
    	BearerContextsToBeCreatedInCreateSessionRequest&>(bearerContextsToBeCreated.getGroupedIe(msgType, 0));
    ...
    for (Uint8 i = 0; i < data.bearerContextsToBeRemovedCount; i++)
    {
        ...
        GtpV2Ie::encodeGtpV2IeHeader(buffer, header);
        startIndex = buffer.getCurrentIndex(); 
        BearerContextIe bearerContextsToBeRemoved=
        dynamic_cast<
        BearerContextIe&>(GtpV2IeFactory::getInstance().
        getIeObject(BearerContextIeType));
        BearerContextsToBeRemovedInCreateSessionRequest groupedIeInstance = 
    	dynamic_cast<
    	BearerContextsToBeRemovedInCreateSessionRequest&>(bearerContextsToBeRemoved.getGroupedIe(msgType, 1));
    ...
    if (data.mmeFqCsidIePresent)
    {
        ...
        rc = mmeFqCsid.encodeFqCsidIe(buffer, data.mmeFqCsid);
        endIndex = buffer.getCurrentIndex();
        length = endIndex - startIndex;
    ...
    if (data.sgwFqCsidIePresent)
    {
        ...
        dynamic_cast<
        FqCsidIe&>(GtpV2IeFactory::getInstance().getIeObject(FqCsidIeType));
        rc = sgwFqCsid.encodeFqCsidIe(buffer, data.sgwFqCsid);
        endIndex = buffer.getCurrentIndex();
        length = endIndex - startIndex;
    ...
    if (data.epdgFqCsidIePresent)
    {
        ...
        dynamic_cast<
        FqCsidIe&>(GtpV2IeFactory::getInstance().getIeObject(FqCsidIeType));
        rc = epdgFqCsid.encodeFqCsidIe(buffer, data.epdgFqCsid);
        endIndex = buffer.getCurrentIndex();
        length = endIndex - startIndex;
    ...
    if (data.twanFqCsidIePresent)
    {
        ...
        dynamic_cast<
        FqCsidIe&>(GtpV2IeFactory::getInstance().getIeObject(FqCsidIeType));
        rc = twanFqCsid.encodeFqCsidIe(buffer, data.twanFqCsid);
        endIndex = buffer.getCurrentIndex();
        length = endIndex - startIndex;
    ...
    if (data.userCsgInformationIePresent)
    {
        ...
        GtpV2Ie::encodeGtpV2IeHeader(buffer, header);
        startIndex = buffer.getCurrentIndex(); 
        UciIe userCsgInformation=
        dynamic_cast<
        UciIe&>(GtpV2IeFactory::getInstance().getIeObject(UciIeType));
        rc = userCsgInformation.encodeUciIe(buffer, data.userCsgInformation);
        endIndex = buffer.getCurrentIndex();
        length = endIndex - startIndex;
    ...
    if (data.sgwLdnIePresent)
    {
        ...
        GtpV2Ie::encodeGtpV2IeHeader(buffer, header);
        startIndex = buffer.getCurrentIndex(); 
        LocalDistinguishedNameIe sgwLdn=
        dynamic_cast<
        LocalDistinguishedNameIe&>(GtpV2IeFactory::getInstance().getIeObject(LocalDistinguishedNameIeType));
        rc = sgwLdn.encodeLocalDistinguishedNameIe(buffer, data.sgwLdn);
        endIndex = buffer.getCurrentIndex();
        length = endIndex - startIndex;
    ...
    if (data.epdgLdnIePresent)
    {
        ...
        GtpV2Ie::encodeGtpV2IeHeader(buffer, header);
        startIndex = buffer.getCurrentIndex(); 
        LocalDistinguishedNameIe epdgLdn=
        dynamic_cast<
        LocalDistinguishedNameIe&>(GtpV2IeFactory::getInstance().getIeObject(LocalDistinguishedNameIeType));
        rc = epdgLdn.encodeLocalDistinguishedNameIe(buffer, data.epdgLdn);
        endIndex = buffer.getCurrentIndex();
        length = endIndex - startIndex;
    ...
    if (data.twanLdnIePresent)
    {
        ...
        GtpV2Ie::encodeGtpV2IeHeader(buffer, header);
        startIndex = buffer.getCurrentIndex(); 
        LocalDistinguishedNameIe twanLdn=
        dynamic_cast<
        LocalDistinguishedNameIe&>(GtpV2IeFactory::getInstance().getIeObject(LocalDistinguishedNameIeType));
        rc = twanLdn.encodeLocalDistinguishedNameIe(buffer, data.twanLdn);
        endIndex = buffer.getCurrentIndex();
        length = endIndex - startIndex;
    ...
    if (data.ueLocalIpAddressIePresent)
    {
        ...
        GtpV2Ie::encodeGtpV2IeHeader(buffer, header);
        startIndex = buffer.getCurrentIndex(); 
        IpAddressIe ueLocalIpAddress=
        dynamic_cast<
        IpAddressIe&>(GtpV2IeFactory::getInstance().getIeObject(IpAddressIeType));
        rc = ueLocalIpAddress.encodeIpAddressIe(buffer, data.ueLocalIpAddress);
        endIndex = buffer.getCurrentIndex();
        length = endIndex - startIndex;
    ...
    if (data.ueUdpPortIePresent)
    {
        ...
        GtpV2Ie::encodeGtpV2IeHeader(buffer, header);
        startIndex = buffer.getCurrentIndex(); 
        PortNumberIe ueUdpPort=
        dynamic_cast<
        PortNumberIe&>(GtpV2IeFactory::getInstance().getIeObject(PortNumberIeType));
        rc = ueUdpPort.encodePortNumberIe(buffer, data.ueUdpPort);
        endIndex = buffer.getCurrentIndex();
        length = endIndex - startIndex;
    ...
    if (data.hNbLocalIpAddressIePresent)
    {
        ...
        GtpV2Ie::encodeGtpV2IeHeader(buffer, header);
        startIndex = buffer.getCurrentIndex(); 
        IpAddressIe hNbLocalIpAddress=
        dynamic_cast<
        IpAddressIe&>(GtpV2IeFactory::getInstance().getIeObject(IpAddressIeType));
        rc = hNbLocalIpAddress.encodeIpAddressIe(buffer, data.hNbLocalIpAddress);
        endIndex = buffer.getCurrentIndex();
        length = endIndex - startIndex;
    ...
    if (data.hNbUdpPortIePresent)
    {
        ...
        GtpV2Ie::encodeGtpV2IeHeader(buffer, header);
        startIndex = buffer.getCurrentIndex(); 
        PortNumberIe hNbUdpPort=
        dynamic_cast<
        PortNumberIe&>(GtpV2IeFactory::getInstance().getIeObject(PortNumberIeType));
        rc = hNbUdpPort.encodePortNumberIe(buffer, data.hNbUdpPort);
        endIndex = buffer.getCurrentIndex();
        length = endIndex - startIndex;
    ...
    if (data.mmeS4SgsnIdentifierIePresent)
    {
        ...
        GtpV2Ie::encodeGtpV2IeHeader(buffer, header);
        startIndex = buffer.getCurrentIndex(); 
        IpAddressIe mmeS4SgsnIdentifier=
        dynamic_cast<
        IpAddressIe&>(GtpV2IeFactory::getInstance().getIeObject(IpAddressIeType));
        rc = mmeS4SgsnIdentifier.encodeIpAddressIe(buffer, data.mmeS4SgsnIdentifier);
        endIndex = buffer.getCurrentIndex();
        length = endIndex - startIndex;
    ...
    if (data.epdgIpAddressIePresent)
    {
        ...
        GtpV2Ie::encodeGtpV2IeHeader(buffer, header);
        startIndex = buffer.getCurrentIndex(); 
        IpAddressIe epdgIpAddress=
        dynamic_cast<
        IpAddressIe&>(GtpV2IeFactory::getInstance().getIeObject(IpAddressIeType));
        rc = epdgIpAddress.encodeIpAddressIe(buffer, data.epdgIpAddress);
        endIndex = buffer.getCurrentIndex();
        length = endIndex - startIndex;
    ...
    if (data.mmeS4SgsnsOverloadControlInformationIePresent)
    {
        ...
        dynamic_cast<
        MmeS4SgsnsOverloadControlInformationInCreateSessionRequest&>(mmeS4SgsnsOverloadControlInformation.getGroupedIe(msgType, 0));
    ...
    if (data.sgwsOverloadControlInformationIePresent)
    {
        ...
        dynamic_cast<
        SgwsOverloadControlInformationInCreateSessionRequest&>(sgwsOverloadControlInformation.getGroupedIe(msgType, 1));
    ...
    if (data.twanEpdgsOverloadControlInformationIePresent)
    {
        ...
        GtpV2Ie::encodeGtpV2IeHeader(buffer, header);
        startIndex = buffer.getCurrentIndex(); 
        OverloadControlInformationIe twanEpdgsOverloadControlInformation=
        dynamic_cast<
        OverloadControlInformationIe&>(GtpV2IeFactory::getInstance().getIeObject(OverloadControlInformationIeType));
        TwanEpdgsOverloadControlInformationInCreateSessionRequest groupedIeInstance =
        dynamic_cast<
        TwanEpdgsOverloadControlInformationInCreateSessionRequest&>(twanEpdgsOverloadControlInformation.getGroupedIe(msgType, 2));
    ...
    if (data.originationTimeStampIePresent)
    {
        ...
        GtpV2Ie::encodeGtpV2IeHeader(buffer, header);
        startIndex = buffer.getCurrentIndex(); 
        MillisecondTimeStampIe originationTimeStamp=
        dynamic_cast<
        MillisecondTimeStampIe&>(GtpV2IeFactory::getInstance().getIeObject(MillisecondTimeStampIeType));
        rc = originationTimeStamp.encodeMillisecondTimeStampIe(buffer, data.originationTimeStamp);
        endIndex = buffer.getCurrentIndex();
        length = endIndex - startIndex;
    ...
    if (data.maximumWaitTimeIePresent)
    {
        ...
        GtpV2Ie::encodeGtpV2IeHeader(buffer, header);
        startIndex = buffer.getCurrentIndex(); 
        IntegerNumberIe maximumWaitTime=
        dynamic_cast<
        IntegerNumberIe&>(GtpV2IeFactory::getInstance().getIeObject(IntegerNumberIeType));
        rc = maximumWaitTime.encodeIntegerNumberIe(buffer, data.maximumWaitTime);
        endIndex = buffer.getCurrentIndex();
        length = endIndex - startIndex;
    ...
    if (data.wlanLocationInformationIePresent)
    {
        ...
        GtpV2Ie::encodeGtpV2IeHeader(buffer, header);
        startIndex = buffer.getCurrentIndex(); 
        TwanIdentifierIe wlanLocationInformation=
        dynamic_cast<
        TwanIdentifierIe&>(GtpV2IeFactory::getInstance().getIeObject(TwanIdentifierIeType));
        rc = wlanLocationInformation.encodeTwanIdentifierIe(buffer, data.wlanLocationInformation);
        endIndex = buffer.getCurrentIndex();
        length = endIndex - startIndex;
    ...
    if (data.wlanLocationTimestampIePresent)
    {
        ...
        GtpV2Ie::encodeGtpV2IeHeader(buffer, header);
        startIndex = buffer.getCurrentIndex(); 
        TwanIdentifierTimestampIe wlanLocationTimestamp=
        dynamic_cast<
        TwanIdentifierTimestampIe&>(GtpV2IeFactory::getInstance().getIeObject(TwanIdentifierTimestampIeType));
        rc = wlanLocationTimestamp.encodeTwanIdentifierTimestampIe(buffer, data.wlanLocationTimestamp);
        endIndex = buffer.getCurrentIndex();
        length = endIndex - startIndex;
    ...
    if (data.nbifomContainerIePresent)
    {
        ...
        GtpV2Ie::encodeGtpV2IeHeader(buffer, header);
        startIndex = buffer.getCurrentIndex(); 
        FContainerIe nbifomContainer=
        dynamic_cast<
        FContainerIe&>(GtpV2IeFactory::getInstance().getIeObject(FContainerIeType));
        rc = nbifomContainer.encodeFContainerIe(buffer, data.nbifomContainer);
        endIndex = buffer.getCurrentIndex();
        length = endIndex - startIndex;
    ...
    if (data.remoteUeContextConnectedIePresent)
    {
        ...
        dynamic_cast<
        RemoteUeContextConnectedInCreateSessionRequest&>(remoteUeContextConnected.getGroupedIe(msgType, 0));
    ...
    if (data.a3gppAaaServerIdentifierIePresent)
    {
        ...
        GtpV2Ie::encodeGtpV2IeHeader(buffer, header);
        startIndex = buffer.getCurrentIndex(); 
        NodeIdentifierIe a3gppAaaServerIdentifier=
        dynamic_cast<
        NodeIdentifierIe&>(GtpV2IeFactory::getInstance().getIeObject(NodeIdentifierIeType));
        rc = a3gppAaaServerIdentifier.encodeNodeIdentifierIe(buffer, data.a3gppAaaServerIdentifier);
        endIndex = buffer.getCurrentIndex();
        length = endIndex - startIndex;
    ...
    if (data.extendedProtocolConfigurationOptionsIePresent)
    {
        ...
        GtpV2Ie::encodeGtpV2IeHeader(buffer, header);
        startIndex = buffer.getCurrentIndex(); 
        EpcoIe extendedProtocolConfigurationOptions=
        dynamic_cast<
        EpcoIe&>(GtpV2IeFactory::getInstance().getIeObject(EpcoIeType));
        rc = extendedProtocolConfigurationOptions.encodeEpcoIe(buffer, data.extendedProtocolConfigurationOptions);
        endIndex = buffer.getCurrentIndex();
        length = endIndex - startIndex;
    ...
    if (data.ueTcpPortIePresent)
    {
        ...
        GtpV2Ie::encodeGtpV2IeHeader(buffer, header);
        startIndex = buffer.getCurrentIndex(); 
        PortNumberIe ueTcpPort=
        dynamic_cast<
        PortNumberIe&>(GtpV2IeFactory::getInstance().getIeObject(PortNumberIeType));
        rc = ueTcpPort.encodePortNumberIe(buffer, data.ueTcpPort);
        endIndex = buffer.getCurrentIndex();
        length = endIndex - startIndex;
    ...
    if (data.userLocationInformationForSgwIePresent)
    {
        ...
        GtpV2Ie::encodeGtpV2IeHeader(buffer, header);
        startIndex = buffer.getCurrentIndex(); 
        UliIe userLocationInformationForSgw=
        dynamic_cast<
        UliIe&>(GtpV2IeFactory::getInstance().getIeObject(UliIeType));
        rc = userLocationInformationForSgw.encodeUliIe(buffer, data.userLocationInformationForSgw);
        endIndex = buffer.getCurrentIndex();
        length = endIndex - startIndex;
    ...
    if (data.sgwUNodeNameIePresent)
    {
        ...
        rc = sgwUNodeName.encodeFqdnIe(buffer, data.sgwUNodeName);
        endIndex = buffer.getCurrentIndex();
        length = endIndex - startIndex;
...
displayCreateSessionRequestMsgData_v(CreateSessionRequestMsgData const &data, Debug &stream)
{
    ...
    if (data.pgwS5S8AddressForControlPlaneOrPmipIePresent)
    {
        ...
        dynamic_cast<
        FTeidIe&>(GtpV2IeFactory::getInstance().getIeObject(FTeidIeType));
        pgwS5S8AddressForControlPlaneOrPmip.displayFTeidIe_v(data.pgwS5S8AddressForControlPlaneOrPmip, stream);
    ...
    dynamic_cast<
    ApnIe&>(GtpV2IeFactory::getInstance().getIeObject(ApnIeType));
    accessPointName.displayApnIe_v(data.accessPointName, stream);
    ...
    if (data.pdnAddressAllocationIePresent)
    {
        ...
        dynamic_cast<
        PaaIe&>(GtpV2IeFactory::getInstance().getIeObject(PaaIeType));
        pdnAddressAllocation.displayPaaIe_v(data.pdnAddressAllocation, stream);
    ...
    if (data.maximumApnRestrictionIePresent)
    {
        ...
        dynamic_cast<
        ApnRestrictionIe&>(GtpV2IeFactory::getInstance().getIeObject(ApnRestrictionIeType));
        maximumApnRestriction.displayApnRestrictionIe_v(data.maximumApnRestriction, stream);
    ...
    if (data.trustedWlanModeIndicationIePresent)
    {
        ...
        dynamic_cast<
        TwmiIe&>(GtpV2IeFactory::getInstance().getIeObject(TwmiIeType));
        trustedWlanModeIndication.displayTwmiIe_v(data.trustedWlanModeIndication, stream);
    ...
    if (data.protocolConfigurationOptionsIePresent)
    {
        ...
        dynamic_cast<
        PcoIe&>(GtpV2IeFactory::getInstance().getIeObject(PcoIeType));
        protocolConfigurationOptions.displayPcoIe_v(data.protocolConfigurationOptions, stream);
    ...
    if (data.mmeFqCsidIePresent)
    {
        ...
        dynamic_cast<
        FqCsidIe&>(GtpV2IeFactory::getInstance().getIeObject(FqCsidIeType));
        mmeFqCsid.displayFqCsidIe_v(data.mmeFqCsid, stream);
    ...
    if (data.sgwFqCsidIePresent)
    {
        ...
        dynamic_cast<
        FqCsidIe&>(GtpV2IeFactory::getInstance().getIeObject(FqCsidIeType));
        sgwFqCsid.displayFqCsidIe_v(data.sgwFqCsid, stream);
    ...
    if (data.epdgFqCsidIePresent)
    {
        ...
        dynamic_cast<
        FqCsidIe&>(GtpV2IeFactory::getInstance().getIeObject(FqCsidIeType));
        epdgFqCsid.displayFqCsidIe_v(data.epdgFqCsid, stream);
    ...
    if (data.twanFqCsidIePresent)
    {
        ...
        dynamic_cast<
        FqCsidIe&>(GtpV2IeFactory::getInstance().getIeObject(FqCsidIeType));
        twanFqCsid.displayFqCsidIe_v(data.twanFqCsid, stream);
    ...
    if (data.userCsgInformationIePresent)
    {
        ...
        dynamic_cast<
        UciIe&>(GtpV2IeFactory::getInstance().getIeObject(UciIeType));
        userCsgInformation.displayUciIe_v(data.userCsgInformation, stream);
    ...
    if (data.sgwLdnIePresent)
    {
        ...
        dynamic_cast<
        LocalDistinguishedNameIe&>(GtpV2IeFactory::getInstance().getIeObject(LocalDistinguishedNameIeType));
        sgwLdn.displayLocalDistinguishedNameIe_v(data.sgwLdn, stream);
    ...
    if (data.epdgLdnIePresent)
    {
        ...
        dynamic_cast<
        LocalDistinguishedNameIe&>(GtpV2IeFactory::getInstance().getIeObject(LocalDistinguishedNameIeType));
        epdgLdn.displayLocalDistinguishedNameIe_v(data.epdgLdn, stream);
    ...
    if (data.twanLdnIePresent)
    {
        ...
        dynamic_cast<
        LocalDistinguishedNameIe&>(GtpV2IeFactory::getInstance().getIeObject(LocalDistinguishedNameIeType));
        twanLdn.displayLocalDistinguishedNameIe_v(data.twanLdn, stream);
    ...
    if (data.ueLocalIpAddressIePresent)
    {
        ...
        dynamic_cast<
        IpAddressIe&>(GtpV2IeFactory::getInstance().getIeObject(IpAddressIeType));
        ueLocalIpAddress.displayIpAddressIe_v(data.ueLocalIpAddress, stream);
    ...
    if (data.ueUdpPortIePresent)
    {
        ...
        dynamic_cast<
        PortNumberIe&>(GtpV2IeFactory::getInstance().getIeObject(PortNumberIeType));
        ueUdpPort.displayPortNumberIe_v(data.ueUdpPort, stream);
    ...
    if (data.hNbLocalIpAddressIePresent)
    {
        ...
        dynamic_cast<
        IpAddressIe&>(GtpV2IeFactory::getInstance().getIeObject(IpAddressIeType));
        hNbLocalIpAddress.displayIpAddressIe_v(data.hNbLocalIpAddress, stream);
    ...
    if (data.hNbUdpPortIePresent)
    {
        ...
        dynamic_cast<
        PortNumberIe&>(GtpV2IeFactory::getInstance().getIeObject(PortNumberIeType));
        hNbUdpPort.displayPortNumberIe_v(data.hNbUdpPort, stream);
    ...
    if (data.mmeS4SgsnIdentifierIePresent)
    {
        ...
        dynamic_cast<
        IpAddressIe&>(GtpV2IeFactory::getInstance().getIeObject(IpAddressIeType));
        mmeS4SgsnIdentifier.displayIpAddressIe_v(data.mmeS4SgsnIdentifier, stream);
    ...
    if (data.epdgIpAddressIePresent)
    {
        ...
        dynamic_cast<
        IpAddressIe&>(GtpV2IeFactory::getInstance().getIeObject(IpAddressIeType));
        epdgIpAddress.displayIpAddressIe_v(data.epdgIpAddress, stream);
    ...
    if (data.originationTimeStampIePresent)
    {
        ...
        dynamic_cast<
        MillisecondTimeStampIe&>(GtpV2IeFactory::getInstance().getIeObject(MillisecondTimeStampIeType));
        originationTimeStamp.displayMillisecondTimeStampIe_v(data.originationTimeStamp, stream);
    ...
    if (data.maximumWaitTimeIePresent)
    {
        ...
        dynamic_cast<
        IntegerNumberIe&>(GtpV2IeFactory::getInstance().getIeObject(IntegerNumberIeType));
        maximumWaitTime.displayIntegerNumberIe_v(data.maximumWaitTime, stream);
    ...
    if (data.wlanLocationInformationIePresent)
    {
        ...
        dynamic_cast<
        TwanIdentifierIe&>(GtpV2IeFactory::getInstance().getIeObject(TwanIdentifierIeType));
        wlanLocationInformation.displayTwanIdentifierIe_v(data.wlanLocationInformation, stream);
    ...
    if (data.wlanLocationTimestampIePresent)
    {
        ...
        dynamic_cast<
        TwanIdentifierTimestampIe&>(GtpV2IeFactory::getInstance().getIeObject(TwanIdentifierTimestampIeType));
        wlanLocationTimestamp.displayTwanIdentifierTimestampIe_v(data.wlanLocationTimestamp, stream);
    ...
    if (data.nbifomContainerIePresent)
    {
        ...
        dynamic_cast<
        FContainerIe&>(GtpV2IeFactory::getInstance().getIeObject(FContainerIeType));
        nbifomContainer.displayFContainerIe_v(data.nbifomContainer, stream);
    ...
    if (data.a3gppAaaServerIdentifierIePresent)
    {
        ...
        dynamic_cast<
        NodeIdentifierIe&>(GtpV2IeFactory::getInstance().getIeObject(NodeIdentifierIeType));
        a3gppAaaServerIdentifier.displayNodeIdentifierIe_v(data.a3gppAaaServerIdentifier, stream);
    ...
    if (data.extendedProtocolConfigurationOptionsIePresent)
    {
        ...
        dynamic_cast<
        EpcoIe&>(GtpV2IeFactory::getInstance().getIeObject(EpcoIeType));
        extendedProtocolConfigurationOptions.displayEpcoIe_v(data.extendedProtocolConfigurationOptions, stream);
    ...
    if (data.ueTcpPortIePresent)
    {
        ...
        dynamic_cast<
        PortNumberIe&>(GtpV2IeFactory::getInstance().getIeObject(PortNumberIeType));
        ueTcpPort.displayPortNumberIe_v(data.ueTcpPort, stream);
    ...
    if (data.userLocationInformationForSgwIePresent)
    {
        ...
        dynamic_cast<
        UliIe&>(GtpV2IeFactory::getInstance().getIeObject(UliIeType));
        userLocationInformationForSgw.displayUliIe_v(data.userLocationInformationForSgw, stream);
    ...
    if (data.sgwUNodeNameIePresent)
    {
        ...
        dynamic_cast<
        FqdnIe&>(GtpV2IeFactory::getInstance().getIeObject(FqdnIeType));
        sgwUNodeName.displayFqdnIe_v(data.sgwUNodeName, stream);
