							...
							const &data)
{
    ...
    if (data.sgwsNodeLevelLoadControlInformationIePresent)
    {
        ...
        dynamic_cast<
        SgwsNodeLevelLoadControlInformationInReleaseAccessBearersResponse&>(sgwsNodeLevelLoadControlInformation.getGroupedIe(msgType, 0));
    ...
    if (data.sgwsOverloadControlInformationIePresent)
    {
        ...
        dynamic_cast<
        SgwsOverloadControlInformationInReleaseAccessBearersResponse&>(sgwsOverloadControlInformation.getGroupedIe(msgType, 0));
