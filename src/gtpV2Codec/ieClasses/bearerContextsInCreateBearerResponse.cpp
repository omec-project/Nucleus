                          ...
                          const &data)
{
    ...
    if (data.s1USgwFTeidIePresent)
    {
        ...
        dynamic_cast<
        FTeidIe&>(GtpV2IeFactory::getInstance().getIeObject(FTeidIeType));
        rc = s1USgwFTeid.encodeFTeidIe(buffer, data.s1USgwFTeid);
        endIndex = buffer.getCurrentIndex();
        length = endIndex - startIndex;
    ...
    if (data.s58USgwFTeidIePresent)
    {
        ...
        GtpV2Ie::encodeGtpV2IeHeader(buffer, header);
        startIndex = buffer.getCurrentIndex(); 
        FTeidIe s58USgwFTeid=
        dynamic_cast<
        FTeidIe&>(GtpV2IeFactory::getInstance().getIeObject(FTeidIeType));
        rc = s58USgwFTeid.encodeFTeidIe(buffer, data.s58USgwFTeid);
        endIndex = buffer.getCurrentIndex();
        length = endIndex - startIndex;
    ...
    if (data.s58UPgwFTeidIePresent)
    {
        ...
        GtpV2Ie::encodeGtpV2IeHeader(buffer, header);
        startIndex = buffer.getCurrentIndex(); 
        FTeidIe s58UPgwFTeid=
        dynamic_cast<
        FTeidIe&>(GtpV2IeFactory::getInstance().getIeObject(FTeidIeType));
        rc = s58UPgwFTeid.encodeFTeidIe(buffer, data.s58UPgwFTeid);
        endIndex = buffer.getCurrentIndex();
        length = endIndex - startIndex;
    ...
    if (data.s12SgwFTeidIePresent)
    {
        ...
        dynamic_cast<
        FTeidIe&>(GtpV2IeFactory::getInstance().getIeObject(FTeidIeType));
        rc = s12SgwFTeid.encodeFTeidIe(buffer, data.s12SgwFTeid);
        endIndex = buffer.getCurrentIndex();
        length = endIndex - startIndex;
    ...
    if (data.s4USgwFTeidIePresent)
    {
        ...
        dynamic_cast<
        FTeidIe&>(GtpV2IeFactory::getInstance().getIeObject(FTeidIeType));
        rc = s4USgwFTeid.encodeFTeidIe(buffer, data.s4USgwFTeid);
        endIndex = buffer.getCurrentIndex();
        length = endIndex - startIndex;
    ...
    if (data.s2bUPgwFTeidIePresent)
    {
        ...
        GtpV2Ie::encodeGtpV2IeHeader(buffer, header);
        startIndex = buffer.getCurrentIndex(); 
        FTeidIe s2bUPgwFTeid=
        dynamic_cast<
        FTeidIe&>(GtpV2IeFactory::getInstance().getIeObject(FTeidIeType));
        rc = s2bUPgwFTeid.encodeFTeidIe(buffer, data.s2bUPgwFTeid);
        endIndex = buffer.getCurrentIndex();
        length = endIndex - startIndex;
    ...
    if (data.s2aUPgwFTeidIePresent)
    {
        ...
        GtpV2Ie::encodeGtpV2IeHeader(buffer, header);
        startIndex = buffer.getCurrentIndex(); 
        FTeidIe s2aUPgwFTeid=
        dynamic_cast<
        FTeidIe&>(GtpV2IeFactory::getInstance().getIeObject(FTeidIeType));
        rc = s2aUPgwFTeid.encodeFTeidIe(buffer, data.s2aUPgwFTeid);
        endIndex = buffer.getCurrentIndex();
        length = endIndex - startIndex;
...
(BearerContextsInCreateBearerResponseData const &data, Debug &stream)
{
     ...
     if (data.s1USgwFTeidIePresent)
    {
        ...
        dynamic_cast<
        FTeidIe&>(GtpV2IeFactory::getInstance().getIeObject(FTeidIeType));
        s1USgwFTeid.displayFTeidIe_v(data.s1USgwFTeid, stream);
     ...
     if (data.s58USgwFTeidIePresent)
    {
        ...
        dynamic_cast<
        FTeidIe&>(GtpV2IeFactory::getInstance().getIeObject(FTeidIeType));
        s58USgwFTeid.displayFTeidIe_v(data.s58USgwFTeid, stream);
     ...
     if (data.s58UPgwFTeidIePresent)
    {
        ...
        dynamic_cast<
        FTeidIe&>(GtpV2IeFactory::getInstance().getIeObject(FTeidIeType));
        s58UPgwFTeid.displayFTeidIe_v(data.s58UPgwFTeid, stream);
     ...
     if (data.s12SgwFTeidIePresent)
    {
        ...
        dynamic_cast<
        FTeidIe&>(GtpV2IeFactory::getInstance().getIeObject(FTeidIeType));
        s12SgwFTeid.displayFTeidIe_v(data.s12SgwFTeid, stream);
     ...
     if (data.s4USgwFTeidIePresent)
    {
        ...
        dynamic_cast<
        FTeidIe&>(GtpV2IeFactory::getInstance().getIeObject(FTeidIeType));
        s4USgwFTeid.displayFTeidIe_v(data.s4USgwFTeid, stream);
     ...
     if (data.s2bUPgwFTeidIePresent)
    {
        ...
        dynamic_cast<
        FTeidIe&>(GtpV2IeFactory::getInstance().getIeObject(FTeidIeType));
        s2bUPgwFTeid.displayFTeidIe_v(data.s2bUPgwFTeid, stream);
     ...
     if (data.s2aUPgwFTeidIePresent)
    {
        ...
        dynamic_cast<
        FTeidIe&>(GtpV2IeFactory::getInstance().getIeObject(FTeidIeType));
        s2aUPgwFTeid.displayFTeidIe_v(data.s2aUPgwFTeid, stream);
