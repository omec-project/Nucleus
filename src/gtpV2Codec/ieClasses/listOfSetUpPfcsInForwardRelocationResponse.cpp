...
#include "listOfSetUpPfcsInForwardRelocationResponse.h"
...
bool ListOfSetUpPfcsInForwardRelocationResponse::
encodeListOfSetUpPfcsInForwardRelocationResponse(MsgBuffer &buffer,
...
bool ListOfSetUpPfcsInForwardRelocationResponse::
decodeListOfSetUpPfcsInForwardRelocationResponse(MsgBuffer &buffer,
                         ListOfSetUpPfcsInForwardRelocationResponseData 
                         &data, Uint16 length)
{
...
void ListOfSetUpPfcsInForwardRelocationResponse::
displayListOfSetUpPfcsInForwardRelocationResponseData_v
(ListOfSetUpPfcsInForwardRelocationResponseData const &data, Debug &stream)
{
    stream.incrIndent();
    stream.add((char *)"ListOfSetUpPfcsInForwardRelocationResponse:");
    stream.endOfLine();
    stream.incrIndent();
