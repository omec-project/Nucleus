...
void populateStateStringMap()
{
    ...
    smUtil->addStateToStrEntry(ded_deact_start,"ded_deact_start");
    smUtil->addStateToStrEntry(ded_deact_wf_bearer_and_session_tearup,"ded_deact_wf_bearer_and_session_tearup");
    smUtil->addStateToStrEntry(ded_deact_wf_bearer_tearup,"ded_deact_wf_bearer_tearup");
    smUtil->addStateToStrEntry(ded_deact_wf_session_tearup,"ded_deact_wf_session_tearup");
    smUtil->addStateToStrEntry(default_mme_state,"default_mme_state");
    smUtil->addStateToStrEntry(delete_bearer_start,"delete_bearer_start");
    smUtil->addStateToStrEntry(delete_bearer_wf_deact_complete,"delete_bearer_wf_deact_complete");
    smUtil->addStateToStrEntry(delete_bearer_wf_paging_complete,"delete_bearer_wf_paging_complete");
