...
=======
	 mme_msg_tx_m = new mme_msg_tx_counters;
	 mme_procedures_m = new mme_procedures_counters;
>>>>>>> 86d267872cd432e8e3801081caa1f6e4f32950fd
...
mme_procedures_service_request_proc_hss_init(mme_procedures_family.Add({{"procedure","SERVICE_REQUEST_PROC"},{"init_by","hss_init"}})),
...
mme_msg_tx_s1ap_path_switch_request_ack(mme_msg_tx_family.Add({{"interface","s1ap"},{"msg_type","path_switch_request_ack"}})),
mme_msg_tx_s1ap_path_switch_request_fail(mme_msg_tx_family.Add({{"interface","s1ap"},{"msg_type","path_switch_request_fail"}})),
...
mme_msg_tx_s6a_delete_subscriber_data_answer(mme_msg_tx_family.Add({{"interface","s6a"},{"msg_type","delete_subscriber_data_answer"}}))
{
}
...
mme_msg_rx_s6a_delete_subscriber_data_request(mme_msg_rx_family.Add({{"interface","s6a"},{"msg_type","delete_subscriber_data_request"}})),
...
mme_procedures_s1_enb_handover_proc_success(mme_procedures_family.Add({{"procedure","S1_ENB_HANDOVER_PROC"},{"proc_result","success"}})),
mme_procedures_s1_enb_handover_proc_failure(mme_procedures_family.Add({{"procedure","S1_ENB_HANDOVER_PROC"},{"proc_result","failure"}})),
mme_procedures_x2_enb_handover_proc(mme_procedures_family.Add({{"procedure","X2_ENB_HANDOVER_PROC"}})),
mme_procedures_x2_enb_handover_proc_success(mme_procedures_family.Add({{"procedure","X2_ENB_HANDOVER_PROC"},{"proc_result","success"}})),
mme_procedures_x2_enb_handover_proc_failure(mme_procedures_family.Add({{"procedure","X2_ENB_HANDOVER_PROC"},{"proc_result","failure"}})),
mme_procedures_erab_mod_ind_proc(mme_procedures_family.Add({{"procedure","ERAB_MOD_IND_PROC"}})),
mme_procedures_erab_mod_ind_proc_success(mme_procedures_family.Add({{"procedure","ERAB_MOD_IND_PROC"},{"proc_result","success"}})),
mme_procedures_erab_mod_ind_proc_failure(mme_procedures_family.Add({{"procedure","ERAB_MOD_IND_PROC"},{"proc_result","failure"}})),
mme_procedures_create_bearer_proc(mme_procedures_family.Add({{"procedure","CREATE_BEARER_PROC"}})),
...
mme_msg_rx_s1ap_erab_setup_response(mme_msg_rx_family.Add({{"interface","s1ap"},{"msg_type","erab_setup_response"}})),
mme_msg_rx_s1ap_erab_release_response(mme_msg_rx_family.Add({{"interface","s1ap"},{"msg_type","erab_release_response"}})),
mme_msg_rx_s1ap_path_switch_request(mme_msg_rx_family.Add({{"interface","s1ap"},{"msg_type","path_switch_request"}})),
mme_msg_rx_s6a_authentication_information_answer(mme_msg_rx_family.Add({{"interface","s6a"},{"msg_type","authentication_information_answer"}})),
mme_msg_rx_s6a_update_location_answer(mme_msg_rx_family.Add({{"interface","s6a"},{"msg_type","update_location_answer"}})),
mme_msg_rx_s6a_purge_answer(mme_msg_rx_family.Add({{"interface","s6a"},{"msg_type","purge_answer"}})),
mme_msg_rx_s6a_cancel_location_request(mme_msg_rx_family.Add({{"interface","s6a"},{"msg_type","cancel_location_request"}})),
...
<<<<<<< HEAD
	case mmeStatsCounter::MME_PROCEDURES_SERVICE_REQUEST_PROC_HSS_INIT:
	{
		mme_procedures_m->mme_procedures_service_request_proc_hss_init.Increment();
=======
...
<<<<<<< HEAD
		    ...
		    mme_procedures_DynamicMetricObject1 *obj = mme_procedures_m->add_dynamic1("procedure","SERVICE_REQUEST_PROC","init_by","hss_init",it->first, it->second);
=======
		    mme_msg_tx_DynamicMetricObject1 *obj = static_cast<mme_msg_tx_DynamicMetricObject1 *>(it1->second);
		    obj->counter.Increment();
		} else {
...
<<<<<<< HEAD
		    ...
		    mme_procedures_DynamicMetricObject2 *obj = mme_procedures_m->add_dynamic2("procedure","SERVICE_REQUEST_PROC","init_by","hss_init",it1->first, it1->second, it2->first, it2->second);
=======
		    mme_msg_tx_DynamicMetricObject2 *obj = static_cast<mme_msg_tx_DynamicMetricObject2 *>(itf->second);
		    obj->counter.Increment();
		} else {
...
<<<<<<< HEAD
		    ...
		    mme_procedures_DynamicMetricObject3 *obj = mme_procedures_m->add_dynamic3("procedure","SERVICE_REQUEST_PROC","init_by","hss_init",it1->first, it1->second, it2->first, it2->second, it3->first, it3->second);
=======
		    mme_msg_tx_DynamicMetricObject3 *obj = static_cast<mme_msg_tx_DynamicMetricObject3 *>(itf->second);
		    obj->counter.Increment();
		} else {
...
=======
	case mmeStatsCounter::MME_MSG_TX_S1AP_PATH_SWITCH_REQUEST_ACK:
	{
		mme_msg_tx_m->mme_msg_tx_s1ap_path_switch_request_ack.Increment();
>>>>>>> 86d267872cd432e8e3801081caa1f6e4f32950fd
		if(labels.size() == 0) {
		break;
		}
...
=======
		    ...
		    mme_msg_tx_DynamicMetricObject1 *obj = mme_msg_tx_m->add_dynamic1("interface","s1ap","msg_type","path_switch_request_ack",it->first, it->second);
>>>>>>> 86d267872cd432e8e3801081caa1f6e4f32950fd
		    auto p1 = std::make_pair(s1, obj);
		    metrics_map.insert(p1);
		    obj->counter.Increment();
...
=======
		    ...
		    mme_msg_tx_DynamicMetricObject2 *obj = mme_msg_tx_m->add_dynamic2("interface","s1ap","msg_type","path_switch_request_ack",it1->first, it1->second, it2->first, it2->second);
>>>>>>> 86d267872cd432e8e3801081caa1f6e4f32950fd
		    auto p1 = std::make_pair(s1, obj);
		    metrics_map.insert(p1);
		    obj->counter.Increment();
...
=======
		    ...
		    mme_msg_tx_DynamicMetricObject3 *obj = mme_msg_tx_m->add_dynamic3("interface","s1ap","msg_type","path_switch_request_ack",it1->first, it1->second, it2->first, it2->second, it3->first, it3->second);
>>>>>>> 86d267872cd432e8e3801081caa1f6e4f32950fd
		    auto p1 = std::make_pair(s1, obj);
		    metrics_map.insert(p1);
		    obj->counter.Increment();
...
=======
	case mmeStatsCounter::MME_MSG_TX_S1AP_PATH_SWITCH_REQUEST_FAIL:
	{
		mme_msg_tx_m->mme_msg_tx_s1ap_path_switch_request_fail.Increment();
>>>>>>> 86d267872cd432e8e3801081caa1f6e4f32950fd
		if(labels.size() == 0) {
		break;
		}
...
=======
		    ...
		    mme_msg_tx_DynamicMetricObject1 *obj = mme_msg_tx_m->add_dynamic1("interface","s1ap","msg_type","path_switch_request_fail",it->first, it->second);
>>>>>>> 86d267872cd432e8e3801081caa1f6e4f32950fd
		    auto p1 = std::make_pair(s1, obj);
		    metrics_map.insert(p1);
		    obj->counter.Increment();
...
=======
		    ...
		    mme_msg_tx_DynamicMetricObject2 *obj = mme_msg_tx_m->add_dynamic2("interface","s1ap","msg_type","path_switch_request_fail",it1->first, it1->second, it2->first, it2->second);
>>>>>>> 86d267872cd432e8e3801081caa1f6e4f32950fd
		    auto p1 = std::make_pair(s1, obj);
		    metrics_map.insert(p1);
		    obj->counter.Increment();
...
=======
		    ...
		    mme_msg_tx_DynamicMetricObject3 *obj = mme_msg_tx_m->add_dynamic3("interface","s1ap","msg_type","path_switch_request_fail",it1->first, it1->second, it2->first, it2->second, it3->first, it3->second);
>>>>>>> 86d267872cd432e8e3801081caa1f6e4f32950fd
		    auto p1 = std::make_pair(s1, obj);
		    metrics_map.insert(p1);
		    obj->counter.Increment();
...
=======
	case mmeStatsCounter::MME_MSG_TX_S6A_DELETE_SUBSCRIBER_DATA_ANSWER:
	{
		mme_msg_tx_m->mme_msg_tx_s6a_delete_subscriber_data_answer.Increment();
>>>>>>> 86d267872cd432e8e3801081caa1f6e4f32950fd
		if(labels.size() == 0) {
		break;
		}
...
=======
		    ...
		    mme_msg_tx_DynamicMetricObject1 *obj = mme_msg_tx_m->add_dynamic1("interface","s6a","msg_type","delete_subscriber_data_answer",it->first, it->second);
>>>>>>> 86d267872cd432e8e3801081caa1f6e4f32950fd
		    auto p1 = std::make_pair(s1, obj);
		    metrics_map.insert(p1);
		    obj->counter.Increment();
...
=======
		    ...
		    mme_msg_tx_DynamicMetricObject2 *obj = mme_msg_tx_m->add_dynamic2("interface","s6a","msg_type","delete_subscriber_data_answer",it1->first, it1->second, it2->first, it2->second);
>>>>>>> 86d267872cd432e8e3801081caa1f6e4f32950fd
		    auto p1 = std::make_pair(s1, obj);
		    metrics_map.insert(p1);
		    obj->counter.Increment();
...
=======
		    ...
		    mme_msg_tx_DynamicMetricObject3 *obj = mme_msg_tx_m->add_dynamic3("interface","s6a","msg_type","delete_subscriber_data_answer",it1->first, it1->second, it2->first, it2->second, it3->first, it3->second);
>>>>>>> 86d267872cd432e8e3801081caa1f6e4f32950fd
		    auto p1 = std::make_pair(s1, obj);
		    metrics_map.insert(p1);
		    obj->counter.Increment();
...
>>>>>>> 86d267872cd432e8e3801081caa1f6e4f32950fd
	...
	case mmeStatsCounter::MME_PROCEDURES_X2_ENB_HANDOVER_PROC:
	{
		mme_procedures_m->mme_procedures_x2_enb_handover_proc.Increment();
		if(labels.size() == 0) {
		break;
		}
		if(labels.size() == 1) {
		...
		if(it1 != metrics_map.end()) {
		    ...
		    mme_procedures_DynamicMetricObject1 *obj = mme_procedures_m->add_dynamic1("procedure","X2_ENB_HANDOVER_PROC",it->first, it->second);
		    auto p1 = std::make_pair(s1, obj);
		    metrics_map.insert(p1);
		    obj->counter.Increment();
		}
		...
		if(itf != metrics_map.end()) {
		    ...
		    mme_procedures_DynamicMetricObject2 *obj = mme_procedures_m->add_dynamic2("procedure","X2_ENB_HANDOVER_PROC",it1->first, it1->second, it2->first, it2->second);
		    auto p1 = std::make_pair(s1, obj);
		    metrics_map.insert(p1);
		    obj->counter.Increment();
		} 
		...
		if(itf != metrics_map.end()) {
		    ...
		    mme_procedures_DynamicMetricObject3 *obj = mme_procedures_m->add_dynamic3("procedure","X2_ENB_HANDOVER_PROC",it1->first, it1->second, it2->first, it2->second, it3->first, it3->second);
		    auto p1 = std::make_pair(s1, obj);
		    metrics_map.insert(p1);
		    obj->counter.Increment();
		}
	...
	case mmeStatsCounter::MME_PROCEDURES_X2_ENB_HANDOVER_PROC_SUCCESS:
	{
		mme_procedures_m->mme_procedures_x2_enb_handover_proc_success.Increment();
		if(labels.size() == 0) {
		break;
		}
		if(labels.size() == 1) {
		...
		if(it1 != metrics_map.end()) {
		    ...
		    mme_procedures_DynamicMetricObject1 *obj = mme_procedures_m->add_dynamic1("procedure","X2_ENB_HANDOVER_PROC","proc_result","success",it->first, it->second);
		    auto p1 = std::make_pair(s1, obj);
		    metrics_map.insert(p1);
		    obj->counter.Increment();
		}
		...
		if(itf != metrics_map.end()) {
		    ...
		    mme_procedures_DynamicMetricObject2 *obj = mme_procedures_m->add_dynamic2("procedure","X2_ENB_HANDOVER_PROC","proc_result","success",it1->first, it1->second, it2->first, it2->second);
		    auto p1 = std::make_pair(s1, obj);
		    metrics_map.insert(p1);
		    obj->counter.Increment();
		} 
		...
		if(itf != metrics_map.end()) {
		    ...
		    mme_procedures_DynamicMetricObject3 *obj = mme_procedures_m->add_dynamic3("procedure","X2_ENB_HANDOVER_PROC","proc_result","success",it1->first, it1->second, it2->first, it2->second, it3->first, it3->second);
		    auto p1 = std::make_pair(s1, obj);
		    metrics_map.insert(p1);
		    obj->counter.Increment();
		}
	...
	case mmeStatsCounter::MME_PROCEDURES_X2_ENB_HANDOVER_PROC_FAILURE:
	{
		mme_procedures_m->mme_procedures_x2_enb_handover_proc_failure.Increment();
		if(labels.size() == 0) {
		break;
		}
		if(labels.size() == 1) {
		...
		if(it1 != metrics_map.end()) {
		    ...
		    mme_procedures_DynamicMetricObject1 *obj = mme_procedures_m->add_dynamic1("procedure","X2_ENB_HANDOVER_PROC","proc_result","failure",it->first, it->second);
		    auto p1 = std::make_pair(s1, obj);
		    metrics_map.insert(p1);
		    obj->counter.Increment();
		}
		...
		if(itf != metrics_map.end()) {
		    ...
		    mme_procedures_DynamicMetricObject2 *obj = mme_procedures_m->add_dynamic2("procedure","X2_ENB_HANDOVER_PROC","proc_result","failure",it1->first, it1->second, it2->first, it2->second);
		    auto p1 = std::make_pair(s1, obj);
		    metrics_map.insert(p1);
		    obj->counter.Increment();
		} 
		...
		if(itf != metrics_map.end()) {
		    ...
		    mme_procedures_DynamicMetricObject3 *obj = mme_procedures_m->add_dynamic3("procedure","X2_ENB_HANDOVER_PROC","proc_result","failure",it1->first, it1->second, it2->first, it2->second, it3->first, it3->second);
		    auto p1 = std::make_pair(s1, obj);
		    metrics_map.insert(p1);
		    obj->counter.Increment();
		}
...
<<<<<<< HEAD
	case mmeStatsCounter::MME_MSG_RX_S1AP_ERAB_RELEASE_RESPONSE:
	{
		mme_msg_rx_m->mme_msg_rx_s1ap_erab_release_response.Increment();
=======
	case mmeStatsCounter::MME_MSG_RX_S1AP_PATH_SWITCH_REQUEST:
	{
		mme_msg_rx_m->mme_msg_rx_s1ap_path_switch_request.Increment();
>>>>>>> 86d267872cd432e8e3801081caa1f6e4f32950fd
		if(labels.size() == 0) {
		break;
		}
...
<<<<<<< HEAD
		    mme_msg_rx_DynamicMetricObject1 *obj = mme_msg_rx_m->add_dynamic1("interface","s1ap","msg_type","erab_release_response",it->first, it->second);
=======
		    mme_msg_rx_DynamicMetricObject1 *obj = mme_msg_rx_m->add_dynamic1("interface","s1ap","msg_type","path_switch_request",it->first, it->second);
>>>>>>> 86d267872cd432e8e3801081caa1f6e4f32950fd
		    auto p1 = std::make_pair(s1, obj);
		    metrics_map.insert(p1);
		    obj->counter.Increment();
...
<<<<<<< HEAD
		    mme_msg_rx_DynamicMetricObject2 *obj = mme_msg_rx_m->add_dynamic2("interface","s1ap","msg_type","erab_release_response",it1->first, it1->second, it2->first, it2->second);
=======
		    mme_msg_rx_DynamicMetricObject2 *obj = mme_msg_rx_m->add_dynamic2("interface","s1ap","msg_type","path_switch_request",it1->first, it1->second, it2->first, it2->second);
>>>>>>> 86d267872cd432e8e3801081caa1f6e4f32950fd
		    auto p1 = std::make_pair(s1, obj);
		    metrics_map.insert(p1);
		    obj->counter.Increment();
...
<<<<<<< HEAD
		    mme_msg_rx_DynamicMetricObject3 *obj = mme_msg_rx_m->add_dynamic3("interface","s1ap","msg_type","erab_release_response",it1->first, it1->second, it2->first, it2->second, it3->first, it3->second);
=======
		    mme_msg_rx_DynamicMetricObject3 *obj = mme_msg_rx_m->add_dynamic3("interface","s1ap","msg_type","path_switch_request",it1->first, it1->second, it2->first, it2->second, it3->first, it3->second);
>>>>>>> 86d267872cd432e8e3801081caa1f6e4f32950fd
		    auto p1 = std::make_pair(s1, obj);
		    metrics_map.insert(p1);
		    obj->counter.Increment();
	...
	case mmeStatsCounter::MME_MSG_RX_S6A_DELETE_SUBSCRIBER_DATA_REQUEST:
	{
		mme_msg_rx_m->mme_msg_rx_s6a_delete_subscriber_data_request.Increment();
		if(labels.size() == 0) {
		break;
		}
		if(labels.size() == 1) {
		...
		if(it1 != metrics_map.end()) {
		    ...
		    mme_msg_rx_DynamicMetricObject1 *obj = mme_msg_rx_m->add_dynamic1("interface","s6a","msg_type","delete_subscriber_data_request",it->first, it->second);
		    auto p1 = std::make_pair(s1, obj);
		    metrics_map.insert(p1);
		    obj->counter.Increment();
		}
		...
		if(itf != metrics_map.end()) {
		    ...
		    mme_msg_rx_DynamicMetricObject2 *obj = mme_msg_rx_m->add_dynamic2("interface","s6a","msg_type","delete_subscriber_data_request",it1->first, it1->second, it2->first, it2->second);
		    auto p1 = std::make_pair(s1, obj);
		    metrics_map.insert(p1);
		    obj->counter.Increment();
		} 
		...
		if(itf != metrics_map.end()) {
		    ...
		    mme_msg_rx_DynamicMetricObject3 *obj = mme_msg_rx_m->add_dynamic3("interface","s6a","msg_type","delete_subscriber_data_request",it1->first, it1->second, it2->first, it2->second, it3->first, it3->second);
		    auto p1 = std::make_pair(s1, obj);
		    metrics_map.insert(p1);
		    obj->counter.Increment();
		}
