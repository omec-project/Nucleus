...
nas_attach_request(mme_msg_rx_family.Add({{"interface","nas"},{"msg_type","attach_request"}})),
nas_identity_response(mme_msg_rx_family.Add({{"interface","nas"},{"msg_type","identity_response"}})),
nas_authentication_response(mme_msg_rx_family.Add({{"interface","nas"},{"msg_type","authentication_response"}})),
nas_security_mode_response(mme_msg_rx_family.Add({{"interface","nas"},{"msg_type","security_mode_response"}})),
nas_esm_response(mme_msg_rx_family.Add({{"interface","nas"},{"msg_type","esm_response"}})),
s1ap_init_context_response(mme_msg_rx_family.Add({{"interface","s1ap"},{"msg_type","init_context_rsp_response"}})),
nas_attach_complete(mme_msg_rx_family.Add({{"interface","nas"},{"msg_type","attach_complete"}})),
nas_detach_request(mme_msg_rx_family.Add({{"interface","nas"},{"msg_type","detach_request"}})),
s1ap_release_request(mme_msg_rx_family.Add({{"interface","s1ap"},{"msg_type","s1ap_release_request"}})),
s1ap_release_complete(mme_msg_rx_family.Add({{"interface","s1ap"},{"msg_type","s1ap_release_complete"}})),
s1ap_detach_accept(mme_msg_rx_family.Add({{"interface","s1ap"},{"msg_type","s1ap_detach_accpet"}})),
s1ap_service_request(mme_msg_rx_family.Add({{"interface","s1ap"},{"msg_type","s1ap_service_request"}})),
s1ap_tau_request(mme_msg_rx_family.Add({{"interface","s1ap"},{"msg_type","s1ap_tau_request"}})),
s1ap_handover_request_ack(mme_msg_rx_family.Add({{"interface","s1ap"},{"msg_type","s1ap_handover_request_ack"}})),
s1ap_handover_notify(mme_msg_rx_family.Add({{"interface","s1ap"},{"msg_type","s1ap_handover_notify"}})),
s1ap_handover_required(mme_msg_rx_family.Add({{"interface","s1ap"},{"msg_type","s1ap_handover_required"}})),
s1ap_enb_status_transfer(mme_msg_rx_family.Add({{"interface","s1ap"},{"msg_type","s1ap_enb_status_transfer"}})),
s1ap_handover_cancel(mme_msg_rx_family.Add({{"interface","s1ap"},{"msg_type","s1ap_handover_cancel"}})),
s1ap_handover_failure(mme_msg_rx_family.Add({{"interface","s1ap"},{"msg_type","s1ap_handover_failure"}})),
s1ap_erab_modification_indication(mme_msg_rx_family.Add({{"interface","s1ap"},{"msg_type","s1ap_erab_modification_indication"}})),
s6a_authentication_information_answer(mme_msg_rx_family.Add({{"interface","s6a"},{"msg_type","authentication_information_answer"}})),
s6a_update_location_answer(mme_msg_rx_family.Add({{"interface","s6a"},{"msg_type","update_location_answer"}})),
s6a_purge_answer(mme_msg_rx_family.Add({{"interface","s6a"},{"msg_type","purge_answer"}})),
s6a_cancel_location_request(mme_msg_rx_family.Add({{"interface","s6a"},{"msg_type","cancel_location_request"}})),
s11_create_session_response(mme_msg_rx_family.Add({{"interface","s11"},{"msg_type","create_session_response"}})),
s11_modify_bearer_response(mme_msg_rx_family.Add({{"interface","s11"},{"msg_type","modify_bearer_response"}})),
s11_delete_session_response(mme_msg_rx_family.Add({{"interface","s11"},{"msg_type","delete_session_response"}})),
s11_release_bearer_response(mme_msg_rx_family.Add({{"interface","s11"},{"msg_type","release_bearer_response"}})),
s11_downlink_notification_indication(mme_msg_rx_family.Add({{"interface","s11"},{"msg_type","downlink_notification_indication"}}))
{
}
...
nas_identity_request(mme_msg_tx_family.Add({{"interface","nas"},{"msg_type","identity_request"}})),
nas_authentication_request(mme_msg_tx_family.Add({{"interface","nas"},{"msg_type","authentication_request"}})),
nas_security_mode_command(mme_msg_tx_family.Add({{"interface","nas"},{"msg_type","security_mode_command"}})),
nas_esm_information_request(mme_msg_tx_family.Add({{"interface","nas"},{"msg_type","esm_information_request"}})),
nas_initial_context_request(mme_msg_tx_family.Add({{"interface","nas"},{"msg_type","initial_context_request"}})),
nas_emm_information_req(mme_msg_tx_family.Add({{"interface","nas"},{"msg_type","emm_information_req"}})),
nas_attach_reject(mme_msg_tx_family.Add({{"interface","nas"},{"msg_type","attach_reject"}})),
nas_service_reject(mme_msg_tx_family.Add({{"interface","nas"},{"msg_type","service_reject"}})),
nas_tau_response(mme_msg_tx_family.Add({{"interface","nas"},{"msg_type","tau_response"}})),
nas_erab_modification(mme_msg_tx_family.Add({{"interface","nas"},{"msg_type","erab_modification"}})),
nas_network_initiated_detach(mme_msg_tx_family.Add({{"interface","nas"},{"msg_type","network_initiated_detach"}})),
s1ap_s1_release_command(mme_msg_tx_family.Add({{"interface","s1ap"},{"msg_type","s1_release_command"}})),
s1ap_handover_request(mme_msg_tx_family.Add({{"interface","s1ap"},{"msg_type","handover_request"}})),
s1ap_handover_command(mme_msg_tx_family.Add({{"interface","s1ap"},{"msg_type","handover_command"}})),
s1ap_mme_status_transfer(mme_msg_tx_family.Add({{"interface","nas"},{"msg_type","mme_status_transfer"}})),
s1ap_handover_preparation_failure(mme_msg_tx_family.Add({{"interface","s1ap"},{"msg_type","handover_preparation_failure"}})),
s1ap_handover_cancel_ack(mme_msg_tx_family.Add({{"interface","s1ap"},{"msg_type","handover_cancel_ack"}})),
s1ap_paging_request(mme_msg_tx_family.Add({{"interface","s1ap"},{"msg_type","paging_request"}})),
s1ap_ics_request_paging(mme_msg_tx_family.Add({{"interface","s1ap"},{"msg_type","ics_request_paging"}})),
s1ap_detach_accept(mme_msg_tx_family.Add({{"interface","s1ap"},{"msg_type","detach_accept"}})),
s11_create_session_request(mme_msg_tx_family.Add({{"interface","s11"},{"msg_type","create_session_request"}})),
s11_modify_bearer_request(mme_msg_tx_family.Add({{"interface","s11"},{"msg_type","modify_bearer_request"}})),
s11_delete_session_request(mme_msg_tx_family.Add({{"interface","s11"},{"msg_type","delete_session_request"}})),
s11_downlink_data_notification_ack(mme_msg_tx_family.Add({{"interface","s11"},{"msg_type","downlink_data_notification_ack"}})),
s11_release_bearer_request(mme_msg_tx_family.Add({{"interface","s11"},{"msg_type","release_bearer_request"}})),
s6a_authentication_info_request(mme_msg_tx_family.Add({{"interface","s6a"},{"msg_type","authentication_info_request"}})),
s6a_update_location_request(mme_msg_tx_family.Add({{"interface","s6a"},{"msg_type","update_location_request"}})),
s6a_purge_request(mme_msg_tx_family.Add({{"interface","s6a"},{"msg_type","purge_request"}}))
{
}
...
{
	switch(name) {
	case mmeStatsCounter::MME_NUM_UE_ACTIVE:
	{
	...
	case mmeStatsCounter::MME_NUM_UE_IDLE:
	{
	...
	{
		mme_msg_rx_m->nas_attach_request.Increment();
		for(auto it = labels.begin(); it != labels.end(); it++) {
		std::cout<<"label - ("<<it->first<<","<<it->second<<")"<<std::endl;
		struct Node s1 = {name, it->first, it->second};
		auto it1 = metrics_map.find(s1);
	...
	{
		mme_msg_rx_m->nas_identity_response.Increment();
		for(auto it = labels.begin(); it != labels.end(); it++) {
		std::cout<<"label - ("<<it->first<<","<<it->second<<")"<<std::endl;
		struct Node s1 = {name, it->first, it->second};
		auto it1 = metrics_map.find(s1);
	...
	{
		mme_msg_rx_m->nas_authentication_response.Increment();
		for(auto it = labels.begin(); it != labels.end(); it++) {
		std::cout<<"label - ("<<it->first<<","<<it->second<<")"<<std::endl;
		struct Node s1 = {name, it->first, it->second};
		auto it1 = metrics_map.find(s1);
	...
	{
		mme_msg_rx_m->nas_security_mode_response.Increment();
		for(auto it = labels.begin(); it != labels.end(); it++) {
		std::cout<<"label - ("<<it->first<<","<<it->second<<")"<<std::endl;
		struct Node s1 = {name, it->first, it->second};
		auto it1 = metrics_map.find(s1);
	...
	{
		mme_msg_rx_m->nas_esm_response.Increment();
		for(auto it = labels.begin(); it != labels.end(); it++) {
		std::cout<<"label - ("<<it->first<<","<<it->second<<")"<<std::endl;
		struct Node s1 = {name, it->first, it->second};
		auto it1 = metrics_map.find(s1);
	...
	{
		mme_msg_rx_m->s1ap_init_context_response.Increment();
		for(auto it = labels.begin(); it != labels.end(); it++) {
		std::cout<<"label - ("<<it->first<<","<<it->second<<")"<<std::endl;
		struct Node s1 = {name, it->first, it->second};
		auto it1 = metrics_map.find(s1);
		if(it1 != metrics_map.end()) {
		    ...
		    mme_msg_rx_DynamicMetricObject *obj = mme_msg_rx_m->add_dynamic("interface","s1ap","msg_type","init_context_rsp_response",it->first, it->second);
		    auto p1 = std::make_pair(s1, obj);
		    metrics_map.insert(p1);
		    obj->counter.Increment();
		}
	...
	{
		mme_msg_rx_m->nas_attach_complete.Increment();
		for(auto it = labels.begin(); it != labels.end(); it++) {
		std::cout<<"label - ("<<it->first<<","<<it->second<<")"<<std::endl;
		struct Node s1 = {name, it->first, it->second};
		auto it1 = metrics_map.find(s1);
	...
	{
		mme_msg_rx_m->nas_detach_request.Increment();
		for(auto it = labels.begin(); it != labels.end(); it++) {
		std::cout<<"label - ("<<it->first<<","<<it->second<<")"<<std::endl;
		struct Node s1 = {name, it->first, it->second};
		auto it1 = metrics_map.find(s1);
	...
	{
		mme_msg_rx_m->s1ap_release_request.Increment();
		for(auto it = labels.begin(); it != labels.end(); it++) {
		std::cout<<"label - ("<<it->first<<","<<it->second<<")"<<std::endl;
		struct Node s1 = {name, it->first, it->second};
		auto it1 = metrics_map.find(s1);
		if(it1 != metrics_map.end()) {
		    ...
		    mme_msg_rx_DynamicMetricObject *obj = mme_msg_rx_m->add_dynamic("interface","s1ap","msg_type","s1ap_release_request",it->first, it->second);
		    auto p1 = std::make_pair(s1, obj);
		    metrics_map.insert(p1);
		    obj->counter.Increment();
		}
	...
	{
		mme_msg_rx_m->s1ap_release_complete.Increment();
		for(auto it = labels.begin(); it != labels.end(); it++) {
		std::cout<<"label - ("<<it->first<<","<<it->second<<")"<<std::endl;
		struct Node s1 = {name, it->first, it->second};
		auto it1 = metrics_map.find(s1);
		if(it1 != metrics_map.end()) {
		    ...
		    mme_msg_rx_DynamicMetricObject *obj = mme_msg_rx_m->add_dynamic("interface","s1ap","msg_type","s1ap_release_complete",it->first, it->second);
		    auto p1 = std::make_pair(s1, obj);
		    metrics_map.insert(p1);
		    obj->counter.Increment();
		}
	...
	{
		mme_msg_rx_m->s1ap_detach_accept.Increment();
		for(auto it = labels.begin(); it != labels.end(); it++) {
		std::cout<<"label - ("<<it->first<<","<<it->second<<")"<<std::endl;
		struct Node s1 = {name, it->first, it->second};
		auto it1 = metrics_map.find(s1);
		if(it1 != metrics_map.end()) {
		    ...
		    mme_msg_rx_DynamicMetricObject *obj = mme_msg_rx_m->add_dynamic("interface","s1ap","msg_type","s1ap_detach_accpet",it->first, it->second);
		    auto p1 = std::make_pair(s1, obj);
		    metrics_map.insert(p1);
		    obj->counter.Increment();
		}
	...
	{
		mme_msg_rx_m->s1ap_service_request.Increment();
		for(auto it = labels.begin(); it != labels.end(); it++) {
		std::cout<<"label - ("<<it->first<<","<<it->second<<")"<<std::endl;
		struct Node s1 = {name, it->first, it->second};
		auto it1 = metrics_map.find(s1);
		if(it1 != metrics_map.end()) {
		    ...
		    mme_msg_rx_DynamicMetricObject *obj = mme_msg_rx_m->add_dynamic("interface","s1ap","msg_type","s1ap_service_request",it->first, it->second);
		    auto p1 = std::make_pair(s1, obj);
		    metrics_map.insert(p1);
		    obj->counter.Increment();
		}
	...
	{
		mme_msg_rx_m->s1ap_tau_request.Increment();
		for(auto it = labels.begin(); it != labels.end(); it++) {
		std::cout<<"label - ("<<it->first<<","<<it->second<<")"<<std::endl;
		struct Node s1 = {name, it->first, it->second};
		auto it1 = metrics_map.find(s1);
		if(it1 != metrics_map.end()) {
		    ...
		    mme_msg_rx_DynamicMetricObject *obj = mme_msg_rx_m->add_dynamic("interface","s1ap","msg_type","s1ap_tau_request",it->first, it->second);
		    auto p1 = std::make_pair(s1, obj);
		    metrics_map.insert(p1);
		    obj->counter.Increment();
		}
	...
	{
		mme_msg_rx_m->s1ap_handover_request_ack.Increment();
		for(auto it = labels.begin(); it != labels.end(); it++) {
		std::cout<<"label - ("<<it->first<<","<<it->second<<")"<<std::endl;
		struct Node s1 = {name, it->first, it->second};
		auto it1 = metrics_map.find(s1);
		if(it1 != metrics_map.end()) {
		    ...
		    mme_msg_rx_DynamicMetricObject *obj = mme_msg_rx_m->add_dynamic("interface","s1ap","msg_type","s1ap_handover_request_ack",it->first, it->second);
		    auto p1 = std::make_pair(s1, obj);
		    metrics_map.insert(p1);
		    obj->counter.Increment();
		}
	...
	{
		mme_msg_rx_m->s1ap_handover_notify.Increment();
		for(auto it = labels.begin(); it != labels.end(); it++) {
		std::cout<<"label - ("<<it->first<<","<<it->second<<")"<<std::endl;
		struct Node s1 = {name, it->first, it->second};
		auto it1 = metrics_map.find(s1);
		if(it1 != metrics_map.end()) {
		    ...
		    mme_msg_rx_DynamicMetricObject *obj = mme_msg_rx_m->add_dynamic("interface","s1ap","msg_type","s1ap_handover_notify",it->first, it->second);
		    auto p1 = std::make_pair(s1, obj);
		    metrics_map.insert(p1);
		    obj->counter.Increment();
		}
	...
	{
		mme_msg_rx_m->s1ap_handover_required.Increment();
		for(auto it = labels.begin(); it != labels.end(); it++) {
		std::cout<<"label - ("<<it->first<<","<<it->second<<")"<<std::endl;
		struct Node s1 = {name, it->first, it->second};
		auto it1 = metrics_map.find(s1);
		if(it1 != metrics_map.end()) {
		    ...
		    mme_msg_rx_DynamicMetricObject *obj = mme_msg_rx_m->add_dynamic("interface","s1ap","msg_type","s1ap_handover_required",it->first, it->second);
		    auto p1 = std::make_pair(s1, obj);
		    metrics_map.insert(p1);
		    obj->counter.Increment();
		}
	...
	{
		mme_msg_rx_m->s1ap_enb_status_transfer.Increment();
		for(auto it = labels.begin(); it != labels.end(); it++) {
		std::cout<<"label - ("<<it->first<<","<<it->second<<")"<<std::endl;
		struct Node s1 = {name, it->first, it->second};
		auto it1 = metrics_map.find(s1);
		if(it1 != metrics_map.end()) {
		    ...
		    mme_msg_rx_DynamicMetricObject *obj = mme_msg_rx_m->add_dynamic("interface","s1ap","msg_type","s1ap_enb_status_transfer",it->first, it->second);
		    auto p1 = std::make_pair(s1, obj);
		    metrics_map.insert(p1);
		    obj->counter.Increment();
		}
	...
	{
		mme_msg_rx_m->s1ap_handover_cancel.Increment();
		for(auto it = labels.begin(); it != labels.end(); it++) {
		std::cout<<"label - ("<<it->first<<","<<it->second<<")"<<std::endl;
		struct Node s1 = {name, it->first, it->second};
		auto it1 = metrics_map.find(s1);
		if(it1 != metrics_map.end()) {
		    ...
		    mme_msg_rx_DynamicMetricObject *obj = mme_msg_rx_m->add_dynamic("interface","s1ap","msg_type","s1ap_handover_cancel",it->first, it->second);
		    auto p1 = std::make_pair(s1, obj);
		    metrics_map.insert(p1);
		    obj->counter.Increment();
		}
	...
	{
		mme_msg_rx_m->s1ap_handover_failure.Increment();
		for(auto it = labels.begin(); it != labels.end(); it++) {
		std::cout<<"label - ("<<it->first<<","<<it->second<<")"<<std::endl;
		struct Node s1 = {name, it->first, it->second};
		auto it1 = metrics_map.find(s1);
		if(it1 != metrics_map.end()) {
		    ...
		    mme_msg_rx_DynamicMetricObject *obj = mme_msg_rx_m->add_dynamic("interface","s1ap","msg_type","s1ap_handover_failure",it->first, it->second);
		    auto p1 = std::make_pair(s1, obj);
		    metrics_map.insert(p1);
		    obj->counter.Increment();
		}
	...
	{
		mme_msg_rx_m->s1ap_erab_modification_indication.Increment();
		for(auto it = labels.begin(); it != labels.end(); it++) {
		std::cout<<"label - ("<<it->first<<","<<it->second<<")"<<std::endl;
		struct Node s1 = {name, it->first, it->second};
		auto it1 = metrics_map.find(s1);
		if(it1 != metrics_map.end()) {
		    ...
		    mme_msg_rx_DynamicMetricObject *obj = mme_msg_rx_m->add_dynamic("interface","s1ap","msg_type","s1ap_erab_modification_indication",it->first, it->second);
		    auto p1 = std::make_pair(s1, obj);
		    metrics_map.insert(p1);
		    obj->counter.Increment();
		}
	...
	{
		mme_msg_rx_m->s6a_authentication_information_answer.Increment();
		for(auto it = labels.begin(); it != labels.end(); it++) {
		std::cout<<"label - ("<<it->first<<","<<it->second<<")"<<std::endl;
		struct Node s1 = {name, it->first, it->second};
		auto it1 = metrics_map.find(s1);
	...
	{
		mme_msg_rx_m->s6a_update_location_answer.Increment();
		for(auto it = labels.begin(); it != labels.end(); it++) {
		std::cout<<"label - ("<<it->first<<","<<it->second<<")"<<std::endl;
		struct Node s1 = {name, it->first, it->second};
		auto it1 = metrics_map.find(s1);
	...
	{
		mme_msg_rx_m->s6a_purge_answer.Increment();
		for(auto it = labels.begin(); it != labels.end(); it++) {
		std::cout<<"label - ("<<it->first<<","<<it->second<<")"<<std::endl;
		struct Node s1 = {name, it->first, it->second};
		auto it1 = metrics_map.find(s1);
	...
	{
		mme_msg_rx_m->s6a_cancel_location_request.Increment();
		for(auto it = labels.begin(); it != labels.end(); it++) {
		std::cout<<"label - ("<<it->first<<","<<it->second<<")"<<std::endl;
		struct Node s1 = {name, it->first, it->second};
		auto it1 = metrics_map.find(s1);
	...
	{
		mme_msg_rx_m->s11_create_session_response.Increment();
		for(auto it = labels.begin(); it != labels.end(); it++) {
		std::cout<<"label - ("<<it->first<<","<<it->second<<")"<<std::endl;
		struct Node s1 = {name, it->first, it->second};
		auto it1 = metrics_map.find(s1);
	...
	{
		mme_msg_rx_m->s11_modify_bearer_response.Increment();
		for(auto it = labels.begin(); it != labels.end(); it++) {
		std::cout<<"label - ("<<it->first<<","<<it->second<<")"<<std::endl;
		struct Node s1 = {name, it->first, it->second};
		auto it1 = metrics_map.find(s1);
	...
	{
		mme_msg_rx_m->s11_delete_session_response.Increment();
		for(auto it = labels.begin(); it != labels.end(); it++) {
		std::cout<<"label - ("<<it->first<<","<<it->second<<")"<<std::endl;
		struct Node s1 = {name, it->first, it->second};
		auto it1 = metrics_map.find(s1);
	...
	{
		mme_msg_rx_m->s11_release_bearer_response.Increment();
		for(auto it = labels.begin(); it != labels.end(); it++) {
		std::cout<<"label - ("<<it->first<<","<<it->second<<")"<<std::endl;
		struct Node s1 = {name, it->first, it->second};
		auto it1 = metrics_map.find(s1);
	...
	{
		mme_msg_rx_m->s11_downlink_notification_indication.Increment();
		for(auto it = labels.begin(); it != labels.end(); it++) {
		std::cout<<"label - ("<<it->first<<","<<it->second<<")"<<std::endl;
		struct Node s1 = {name, it->first, it->second};
		auto it1 = metrics_map.find(s1);
	...
	{
		mme_msg_tx_m->nas_identity_request.Increment();
		for(auto it = labels.begin(); it != labels.end(); it++) {
		std::cout<<"label - ("<<it->first<<","<<it->second<<")"<<std::endl;
		struct Node s1 = {name, it->first, it->second};
		auto it1 = metrics_map.find(s1);
	...
	{
		mme_msg_tx_m->nas_authentication_request.Increment();
		for(auto it = labels.begin(); it != labels.end(); it++) {
		std::cout<<"label - ("<<it->first<<","<<it->second<<")"<<std::endl;
		struct Node s1 = {name, it->first, it->second};
		auto it1 = metrics_map.find(s1);
	...
	{
		mme_msg_tx_m->nas_security_mode_command.Increment();
		for(auto it = labels.begin(); it != labels.end(); it++) {
		std::cout<<"label - ("<<it->first<<","<<it->second<<")"<<std::endl;
		struct Node s1 = {name, it->first, it->second};
		auto it1 = metrics_map.find(s1);
	...
	{
		mme_msg_tx_m->nas_esm_information_request.Increment();
		for(auto it = labels.begin(); it != labels.end(); it++) {
		std::cout<<"label - ("<<it->first<<","<<it->second<<")"<<std::endl;
		struct Node s1 = {name, it->first, it->second};
		auto it1 = metrics_map.find(s1);
	...
	{
		mme_msg_tx_m->nas_initial_context_request.Increment();
		for(auto it = labels.begin(); it != labels.end(); it++) {
		std::cout<<"label - ("<<it->first<<","<<it->second<<")"<<std::endl;
		struct Node s1 = {name, it->first, it->second};
		auto it1 = metrics_map.find(s1);
	...
	{
		mme_msg_tx_m->nas_emm_information_req.Increment();
		for(auto it = labels.begin(); it != labels.end(); it++) {
		std::cout<<"label - ("<<it->first<<","<<it->second<<")"<<std::endl;
		struct Node s1 = {name, it->first, it->second};
		auto it1 = metrics_map.find(s1);
	...
	{
		mme_msg_tx_m->nas_attach_reject.Increment();
		for(auto it = labels.begin(); it != labels.end(); it++) {
		std::cout<<"label - ("<<it->first<<","<<it->second<<")"<<std::endl;
		struct Node s1 = {name, it->first, it->second};
		auto it1 = metrics_map.find(s1);
	...
	{
		mme_msg_tx_m->nas_service_reject.Increment();
		for(auto it = labels.begin(); it != labels.end(); it++) {
		std::cout<<"label - ("<<it->first<<","<<it->second<<")"<<std::endl;
		struct Node s1 = {name, it->first, it->second};
		auto it1 = metrics_map.find(s1);
	...
	{
		mme_msg_tx_m->nas_tau_response.Increment();
		for(auto it = labels.begin(); it != labels.end(); it++) {
		std::cout<<"label - ("<<it->first<<","<<it->second<<")"<<std::endl;
		struct Node s1 = {name, it->first, it->second};
		auto it1 = metrics_map.find(s1);
	...
	case mmeStatsCounter::MME_MSG_TX_NAS_ERAB_MODIFICATION:
	{
		mme_msg_tx_m->nas_erab_modification.Increment();
		for(auto it = labels.begin(); it != labels.end(); it++) {
		std::cout<<"label - ("<<it->first<<","<<it->second<<")"<<std::endl;
		struct Node s1 = {name, it->first, it->second};
		auto it1 = metrics_map.find(s1);
		if(it1 != metrics_map.end()) {
		    ...
		    mme_msg_tx_DynamicMetricObject *obj = mme_msg_tx_m->add_dynamic("interface","nas","msg_type","erab_modification",it->first, it->second);
		    auto p1 = std::make_pair(s1, obj);
		    metrics_map.insert(p1);
		    obj->counter.Increment();
		}
	...
	{
		mme_msg_tx_m->nas_network_initiated_detach.Increment();
		for(auto it = labels.begin(); it != labels.end(); it++) {
		std::cout<<"label - ("<<it->first<<","<<it->second<<")"<<std::endl;
		struct Node s1 = {name, it->first, it->second};
		auto it1 = metrics_map.find(s1);
	...
	{
		mme_msg_tx_m->s1ap_s1_release_command.Increment();
		for(auto it = labels.begin(); it != labels.end(); it++) {
		std::cout<<"label - ("<<it->first<<","<<it->second<<")"<<std::endl;
		struct Node s1 = {name, it->first, it->second};
		auto it1 = metrics_map.find(s1);
	...
	{
		mme_msg_tx_m->s1ap_handover_request.Increment();
		for(auto it = labels.begin(); it != labels.end(); it++) {
		std::cout<<"label - ("<<it->first<<","<<it->second<<")"<<std::endl;
		struct Node s1 = {name, it->first, it->second};
		auto it1 = metrics_map.find(s1);
	...
	{
		mme_msg_tx_m->s1ap_handover_command.Increment();
		for(auto it = labels.begin(); it != labels.end(); it++) {
		std::cout<<"label - ("<<it->first<<","<<it->second<<")"<<std::endl;
		struct Node s1 = {name, it->first, it->second};
		auto it1 = metrics_map.find(s1);
	...
	{
		mme_msg_tx_m->s1ap_mme_status_transfer.Increment();
		for(auto it = labels.begin(); it != labels.end(); it++) {
		std::cout<<"label - ("<<it->first<<","<<it->second<<")"<<std::endl;
		struct Node s1 = {name, it->first, it->second};
		auto it1 = metrics_map.find(s1);
		if(it1 != metrics_map.end()) {
		    ...
		    mme_msg_tx_DynamicMetricObject *obj = mme_msg_tx_m->add_dynamic("interface","nas","msg_type","mme_status_transfer",it->first, it->second);
		    auto p1 = std::make_pair(s1, obj);
		    metrics_map.insert(p1);
		    obj->counter.Increment();
		}
	...
	{
		mme_msg_tx_m->s1ap_handover_preparation_failure.Increment();
		for(auto it = labels.begin(); it != labels.end(); it++) {
		std::cout<<"label - ("<<it->first<<","<<it->second<<")"<<std::endl;
		struct Node s1 = {name, it->first, it->second};
		auto it1 = metrics_map.find(s1);
	...
	{
		mme_msg_tx_m->s1ap_handover_cancel_ack.Increment();
		for(auto it = labels.begin(); it != labels.end(); it++) {
		std::cout<<"label - ("<<it->first<<","<<it->second<<")"<<std::endl;
		struct Node s1 = {name, it->first, it->second};
		auto it1 = metrics_map.find(s1);
	...
	{
		mme_msg_tx_m->s1ap_paging_request.Increment();
		for(auto it = labels.begin(); it != labels.end(); it++) {
		std::cout<<"label - ("<<it->first<<","<<it->second<<")"<<std::endl;
		struct Node s1 = {name, it->first, it->second};
		auto it1 = metrics_map.find(s1);
	...
	{
		mme_msg_tx_m->s1ap_ics_request_paging.Increment();
		for(auto it = labels.begin(); it != labels.end(); it++) {
		std::cout<<"label - ("<<it->first<<","<<it->second<<")"<<std::endl;
		struct Node s1 = {name, it->first, it->second};
		auto it1 = metrics_map.find(s1);
	...
	{
		mme_msg_tx_m->s1ap_detach_accept.Increment();
		for(auto it = labels.begin(); it != labels.end(); it++) {
		std::cout<<"label - ("<<it->first<<","<<it->second<<")"<<std::endl;
		struct Node s1 = {name, it->first, it->second};
		auto it1 = metrics_map.find(s1);
	...
	{
		mme_msg_tx_m->s11_create_session_request.Increment();
		for(auto it = labels.begin(); it != labels.end(); it++) {
		std::cout<<"label - ("<<it->first<<","<<it->second<<")"<<std::endl;
		struct Node s1 = {name, it->first, it->second};
		auto it1 = metrics_map.find(s1);
	...
	{
		mme_msg_tx_m->s11_modify_bearer_request.Increment();
		for(auto it = labels.begin(); it != labels.end(); it++) {
		std::cout<<"label - ("<<it->first<<","<<it->second<<")"<<std::endl;
		struct Node s1 = {name, it->first, it->second};
		auto it1 = metrics_map.find(s1);
	...
	{
		mme_msg_tx_m->s11_delete_session_request.Increment();
		for(auto it = labels.begin(); it != labels.end(); it++) {
		std::cout<<"label - ("<<it->first<<","<<it->second<<")"<<std::endl;
		struct Node s1 = {name, it->first, it->second};
		auto it1 = metrics_map.find(s1);
	...
	{
		mme_msg_tx_m->s11_downlink_data_notification_ack.Increment();
		for(auto it = labels.begin(); it != labels.end(); it++) {
		std::cout<<"label - ("<<it->first<<","<<it->second<<")"<<std::endl;
		struct Node s1 = {name, it->first, it->second};
		auto it1 = metrics_map.find(s1);
	...
	{
		mme_msg_tx_m->s11_release_bearer_request.Increment();
		for(auto it = labels.begin(); it != labels.end(); it++) {
		std::cout<<"label - ("<<it->first<<","<<it->second<<")"<<std::endl;
		struct Node s1 = {name, it->first, it->second};
		auto it1 = metrics_map.find(s1);
	...
	{
		mme_msg_tx_m->s6a_authentication_info_request.Increment();
		for(auto it = labels.begin(); it != labels.end(); it++) {
		std::cout<<"label - ("<<it->first<<","<<it->second<<")"<<std::endl;
		struct Node s1 = {name, it->first, it->second};
		auto it1 = metrics_map.find(s1);
	...
	{
		mme_msg_tx_m->s6a_update_location_request.Increment();
		for(auto it = labels.begin(); it != labels.end(); it++) {
		std::cout<<"label - ("<<it->first<<","<<it->second<<")"<<std::endl;
		struct Node s1 = {name, it->first, it->second};
		auto it1 = metrics_map.find(s1);
	...
	{
		mme_msg_tx_m->s6a_purge_request.Increment();
		for(auto it = labels.begin(); it != labels.end(); it++) {
		std::cout<<"label - ("<<it->first<<","<<it->second<<")"<<std::endl;
		struct Node s1 = {name, it->first, it->second};
		auto it1 = metrics_map.find(s1);
...
int main() {
	...
	mmeStats::Instance()->increment(mmeStatsCounter::MME_NUM_UE_IDLE);
