...
* Constructor
******************************************************************************/
S1HoWfSrcS1RelCmp::S1HoWfSrcS1RelCmp():State(s1_ho_wf_src_s1_rel_cmp)
{
}
...
* Destructor
******************************************************************************/
S1HoWfSrcS1RelCmp::~S1HoWfSrcS1RelCmp()
{
}
...
******************************************************************************/
S1HoWfSrcS1RelCmp* S1HoWfSrcS1RelCmp::Instance()
{
        static S1HoWfSrcS1RelCmp state;
        return &state;
}
...
******************************************************************************/
void S1HoWfSrcS1RelCmp::initialize()
{
        {
