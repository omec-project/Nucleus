...
const uint16_t network_init_detach_state = 39;     
const uint16_t ni_detach_start = 40;     
...
const uint16_t ni_detach_wf_paging_complete = 44;     
const uint16_t ni_detach_wf_s1_rel_comp = 45;     
const uint16_t paging_start = 46;     
const uint16_t paging_wf_service_req = 47;     
const uint16_t s1_ho_wf_ho_notify = 48;     
const uint16_t s1_ho_wf_ho_request_ack = 49;     
const uint16_t s1_ho_wf_modify_bearer_response = 50;     
const uint16_t s1_ho_wf_tau_check = 51;     
const uint16_t s1_ho_wf_tau_request = 52;     
const uint16_t s1_release_start = 53;     
const uint16_t s1_release_wf_release_access_bearer_resp = 54;     
...
const uint16_t ue_init_detach_state = 64;
const uint16_t END_STATE = 65;
...
const uint16_t DSR_FROM_HSS = 125; 
...
const uint16_t GW_CP_REQ_INIT_PAGING = 134; 
const uint16_t GW_INIT_DED_BEARER_AND_SESSION_SETUP = 135; 
const uint16_t HO_CANCEL_REQ_FROM_SRC_ENB = 136; 
const uint16_t HO_FAILURE_FROM_TARGET_ENB = 137; 
const uint16_t HO_NOTIFY_FROM_ENB = 138; 
const uint16_t HO_REQUEST_ACK_FROM_ENB = 139; 
const uint16_t HO_REQUIRED_FROM_ENB = 140; 
const uint16_t HSS_INIT_DETACH = 141; 
const uint16_t HSS_INIT_PAGING = 142; 
...
const uint16_t PAGING_COMPLETE = 150; 
const uint16_t PAGING_FAILURE = 151; 
const uint16_t PGW_INIT_DETACH = 152; 
const uint16_t PURGE_RESP_FROM_HSS = 153; 
const uint16_t REL_AB_RESP_FROM_SGW = 154; 
const uint16_t S1_REL_REQ_FROM_UE = 155; 
const uint16_t SEC_MODE_RESP_FROM_UE = 156; 
const uint16_t SERVICE_REQUEST_FROM_UE = 157; 
const uint16_t START_DED_DEACTIVATION = 158; 
const uint16_t START_UE_DETACH = 159; 
const uint16_t TAU_NOT_REQUIRED = 160; 
const uint16_t TAU_REQUEST_FROM_UE = 161; 
const uint16_t TAU_REQUIRED = 162; 
const uint16_t UE_CTXT_REL_COMP_FROM_ENB = 163; 
const uint16_t ULA_FROM_HSS = 164; 
const uint16_t VALIDATE_IMSI = 165; 
const uint16_t END_EVENT = 166;    
