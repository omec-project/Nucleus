...
const uint16_t ni_detach_start = 19;     
const uint16_t ni_detach_wf_del_sess_resp = 20;     
const uint16_t ni_detach_wf_det_accpt_del_sess_resp = 21;     
const uint16_t ni_detach_wf_detach_accept = 22;     
const uint16_t ni_detach_wf_s1_rel_comp = 23;     
const uint16_t paging_start = 24;     
const uint16_t paging_wf_service_req = 25;     
const uint16_t s1_release_start = 26;     
const uint16_t s1_release_wf_release_access_bearer_resp = 27;     
const uint16_t s1_release_wf_ue_ctxt_release_comp = 28;     
const uint16_t service_request_start = 29;     
const uint16_t service_request_wf_aia = 30;     
const uint16_t service_request_wf_auth_resp_validate = 31;     
const uint16_t service_request_wf_auth_response = 32;     
const uint16_t service_request_wf_init_ctxt_resp = 33;     
...
const uint16_t REL_AB_RESP_FROM_SGW = 122; 
const uint16_t S1_REL_REQ_FROM_UE = 123; 
const uint16_t SEC_MODE_RESP_FROM_UE = 124; 
const uint16_t SERVICE_REQUEST_FROM_UE = 125; 
const uint16_t TAU_REQUEST_FROM_UE = 126; 
const uint16_t UE_CTXT_REL_COMP_FROM_ENB = 127; 
const uint16_t ULA_FROM_HSS = 128; 
const uint16_t VALIDATE_IMSI = 129; 
const uint16_t END_EVENT = 130;    
