...
const uint16_t HO_NOTIFY_FROM_ENB = 118; 
const uint16_t HO_REQUEST_ACK_FROM_ENB = 119; 
const uint16_t HO_REQUIRED_FROM_ENB = 120; 
const uint16_t IDENTITY_RESPONSE_FROM_UE = 121; 
const uint16_t IMSI_VALIDATION_FAILURE = 122; 
const uint16_t IMSI_VALIDATION_SUCCESS = 123; 
const uint16_t INIT_CTXT_RESP_FROM_UE = 124; 
const uint16_t INTRA_S1HO_START = 125; 
const uint16_t MB_RESP_FROM_SGW = 126; 
const uint16_t PURGE_RESP_FROM_HSS = 127; 
const uint16_t REL_AB_RESP_FROM_SGW = 128; 
const uint16_t S1_REL_REQ_FROM_UE = 129; 
const uint16_t SEC_MODE_RESP_FROM_UE = 130; 
const uint16_t SERVICE_REQUEST_FROM_UE = 131; 
const uint16_t TAU_NOT_REQUIRED = 132; 
const uint16_t TAU_REQUEST_FROM_UE = 133; 
const uint16_t TAU_REQUIRED = 134; 
const uint16_t UE_CTXT_REL_COMP_FROM_ENB = 135; 
const uint16_t ULA_FROM_HSS = 136; 
const uint16_t VALIDATE_IMSI = 137; 
const uint16_t END_EVENT = 138;    
